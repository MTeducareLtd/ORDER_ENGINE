<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Account_Display.aspx.cs" Inherits="Account_Display" %>
                ...
                <div class="span12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        <li class="btn-group btn-group-solid">
                            <button type="button" class="btn yellow" runat="server" id="btnpage1">
                                1</button>
                            <button type="button" class="btn default" runat="server" id="btnpage2">
                                2</button>
                            <button type="button" class="btn default" runat="server" id="btnpage3">
                                3</button>
                            <button type="button" class="btn default" runat="server" id="btnpage4">
                                4</button>
                        </li>
                        <li class="btn-group">
            ...
            <asp:UpdatePanel ID="upnlformsubmit" runat="server">
                <ContentTemplate>
                    <div class="row-fluid" id="divformsubmit" runat="server">
                        <div class="span12">
                            <div id="tab_1_3">
                                <div class="row-fluid search-form-default">
                                    <div class="span12">
                                        <div class="table-responsive">
                                            <div id="divprimarycontact" runat="server">
                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddltitle" Enabled="false" runat="server" data-placeholder="Select"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtstudentfirstname" Enabled="false" Placeholder="Student First Name"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtstudentmidname" Enabled="false" Placeholder="Student Middle Name"
                                                                runat="server" Width="86%" ValidationGroup="val1">  </asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtstudentlastname" Enabled="false" Placeholder="Student Last Name"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtflatno" Enabled="false" Placeholder="Address Line 1" runat="server"
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtbuildingno" Enabled="false" Placeholder="Address Line 2" runat="server"
                                                                Width="86%"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtstreetname" Enabled="false" Placeholder="Street Name" runat="server"
                                                                Width="86%"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlcountry" Enabled="false" runat="server" data-placeholder="Select"
                                                                CssClass="chzn-select" AutoPostBack="true" ValidationGroup="val1" OnSelectedIndexChanged="ddlcountry_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlstate" Enabled="false" runat="server" data-placeholder="Select"
                                                                CssClass="chzn-select" ValidationGroup="val1" AutoPostBack="true" OnSelectedIndexChanged="ddlstate_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlcity" Enabled="false" runat="server" data-placeholder="Select"
                                                                CssClass="chzn-select" ValidationGroup="val1" AutoPostBack="true" OnSelectedIndexChanged="ddlcity_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddllocation" Enabled="false" runat="server" data-placeholder="Select"
                                                                CssClass="chzn-select" ValidationGroup="val1">
                                                            </asp:DropDownList>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpincode" Enabled="false" Placeholder="Postal Code" runat="server"
                                                                MaxLength="6" ValidationGroup="val1" Width="86%"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtemailidstudent" Enabled="false" Placeholder="Student Email Address"
                                                                runat="server" Width="86%"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txthandphone1" Enabled="false" Placeholder="Handphone 1" runat="server"
                                                                Width="86%" ValidationGroup="val1" MaxLength="18"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txthandphone2" Enabled="false" Placeholder="Handphone 2" runat="server"
                                                                Width="86%" ValidationGroup="val1" MaxLength="18"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtlandline" Enabled="false" Placeholder="Landline" runat="server"
                                                                Width="86%" ValidationGroup="val1" MaxLength="18"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" ControlToValidate="txtlandline"
                                                                Text="#" runat="server" ValidationGroup="val1" SetFocusOnError="true" ErrorMessage="Please Enter Only Numbers"
                                                                ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator43" runat="server"
                                                                ...
                                                                ValidationGroup="val1" Text="#" SetFocusOnError="true" ValidationExpression="^[0-9]{7,18}$" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="10%">
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtdateofbirth" Enabled="false" Placeholder="Student Date of Birth"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlplaceofbirthcountry" Enabled="false" AutoPostBack="true"
                                                                Placeholder="Student Country of Birth" runat="server" data-placeholder="Select"
                                                                CssClass="chzn-select" ValidationGroup="val1" OnSelectedIndexChanged="ddlplaceofbirthcountry_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator35" ControlToValidate="ddlplaceofbirthcountry"
                                                                Text="#" runat="server" ValidationGroup="val1" SetFocusOnError="True" ErrorMessage="Select Student place of birth State"
                                                                InitialValue="Select" />
                                                        </td>
                                                        <td width="10%">
                                                            State (Of Birth)
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlplaceofbirthstate" Enabled="false" AutoPostBack="true" Placeholder="Student State of Birth"
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="ddlplaceofbirthstate"
                                                                Text="#" runat="server" ValidationGroup="val1" SetFocusOnError="True" ErrorMessage="Select Student place of birth State"
                                                                InitialValue="Select" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlplaceofbirthcity" Enabled="false" Placeholder="Student City of Birth"
                                                                runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="val1"
                                                                OnSelectedIndexChanged="ddlplaceofbirthcity_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator41" ControlToValidate="ddlplaceofbirthcity"
                                                                Text="#" runat="server" ValidationGroup="val1" SetFocusOnError="True" ErrorMessage="Select Student City of birth "
                                                                InitialValue="Select" />
                                                        </td>
                                                        <td width="10%">
                                                            Place (Of Birth)
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtplaceofbirth" Enabled="false" Placeholder="Student Place of Birth"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlgenderadd" Enabled="false" runat="server" data-placeholder="Select"
                                                                CssClass="chzn-select" ValidationGroup="val1">
                                                                <asp:ListItem Value="0">Select</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlnationality" Enabled="false" AutoPostBack="true" Placeholder="Nationality"
                                                                runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="val1">
                                                            </asp:DropDownList>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlmothertongue" Enabled="false" AutoPostBack="true" Placeholder="Mother Tongue"
                                                                runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="val1">
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr id="tr4" runat="server" visible="false">
                                                        ...
                                                        <td width="20%" id="td11" runat="server" visible="false">
                                                            <asp:TextBox ID="txtNationalitySpecify" Enabled="false" Placeholder="Student Nationality"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                        ...
                                                        <td width="20%" id="td15" runat="server" visible="false">
                                                            <asp:TextBox ID="txtmothertonguespecify" Enabled="false" Placeholder="Student Mother Tongue"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                        ...
                                                        <td width="20%" id="td9" runat="server" visible="false">
                                                            <asp:TextBox ID="txtReligionpecify1" Enabled="false" Placeholder="Specify Religion"
                                                                runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlcaste" runat="server" Enabled="false" Placeholder="Student Caste"
                                                                data-placeholder="Select" CssClass="chzn-select" ValidationGroup="val1">
                                                            </asp:DropDownList>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtsubcaste" Enabled="false" Placeholder="Student Sub Caste" runat="server"
                                                    ...
                                                    <tr id="tr5" runat="server" visible="false">
                                                        ...
                                                        <td width="20%" id="td17" runat="server" visible="false">
                                                            <asp:TextBox ID="txtreligionspecify" Enabled="false" runat="server" Width="86%" ValidationGroup="val1"></asp:TextBox>
                                                ...
                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpermanentAdd1" Placeholder="Permanent Address Line 1 " Enabled="false"
                                                                runat="server" Width="86%"></asp:TextBox>
                                                        </td>
                                                        <td width="10%">
                                                            Permanent Add. 2
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpermanentAdd2" Placeholder="Permanent Address Line 2" Enabled="false"
                                                                runat="server" Width="86%"></asp:TextBox>
                                                        </td>
                                                        <td width="10%">
                                                            Street Name
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpermanentstreet" Placeholder="Street Name" runat="server" Enabled="false"
                                                                Width="86%"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlpermanentcountry" runat="server" Enabled="false" data-placeholder="Select"
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlpermstate" AutoPostBack="true" Enabled="false" runat="server"
                                                                Width="86%" ValidationGroup="Val1" data-trigger="hover" data-placement="top"
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlpermanentcity" runat="server" Enabled="false" data-placeholder="Select"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlpermanentlocation" Enabled="false" runat="server" data-placeholder="Select"
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpermanentpostal" Placeholder="Postal Code" Enabled="false" runat="server"
                                                                MaxLength="6" ValidationGroup="Val1" Width="86%" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpermanentHphone1" Placeholder="HandPhone 1" Enabled="false" runat="server"
                                                                Width="86%" ValidationGroup="val1" MaxLength="18"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtpermanentHPhone2" Placeholder="Handphone 2" Enabled="false" runat="server"
                                                                Width="86%" ValidationGroup="val1" MaxLength="18"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtLandline1" Placeholder="Landline" Enabled="false" runat="server"
                                                                Width="86%" ValidationGroup="val1" MaxLength="18"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtquali" runat="server" placeholder="Qualification" Enabled="false"
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtcompany" runat="server" Width="86%" Enabled="false" placeholder="Company"></asp:TextBox>
                                                        </td>
                                                        <td width="10%">
                                                            Office Address
                                                        </td>
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtofficeaddress" runat="server" Width="86%" Enabled="false" placeholder="Office Address"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="10%">
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtofficetelno" runat="server" Enabled="false" placeholder="Office Telephone No."
                                                                ValidationGroup="val1" Width="86%"></asp:TextBox>
                                                        ...
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtdesignation" runat="server" Width="86%" Enabled="false" placeholder="Designation"></asp:TextBox>
                                                        </td>
                                                        <td width="10%">
                                                            Annual Salary
                                                        </td>
                                                        <td width="20%">
                                                            <asp:TextBox ID="txtannaulsalary" runat="server" Width="86%" Enabled="false" placeholder="Annual Salary"></asp:TextBox>
                                                ...
                                                <div class="well" style="text-align: center; background-color: #F0F0F0" id="divstuperinfo"
                                                    ...
                                                    <button class="btn btn-app btn-primary btn-mini radius-4" id="btnstep1next" runat="server"
                                                        validationgroup="val10" onserverclick="btnstep1next_ServerClick">
                                                        Next
                                                    </button>
                                            ...
                                            <div id="divseconadarycontact" runat="server">
                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="10%">
                                                                <button type="button" class="btn btn-app btn-primary btn-mini radius-4" id="btnaddSeccontact"
                                                ...
                                                <asp:DataList ID="dlseccontact" Enabled="false" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                                    OnItemCommand="dlseccontact_ItemCommand" OnItemDataBound="dlseccontact_ItemDataBound">
                                                    <HeaderTemplate>
                                                        <b>Contact Type</b></th>
                                                        <th>
                                                            Contact Name
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label3" Text='<%#DataBinder.Eval(Container.DataItem, "year_pass_desc")%>'
                                                                runat="server"></asp:Label>
                                                        </td>
                                                        <%-- <td>--%>
                                                        <asp:LinkButton ID="lnkedit" runat="server" Visible="false" class="btn default btn-xs purple"
                                                ...
                                                <div id="divseccontactadd" runat="server">
                                                    <table class="table table-striped table-bordered table-advance table-hover">
                                                        ...
                                                        <tr>
                                                            <td width="10%">
                                                                Handphone 1
                                                                <asp:Label ID="label85" runat="server" Text=" *" ForeColor="#FF3300"></asp:Label>
                                                            </td>
                                                            <td width="20%">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator45" ControlToValidate="txtsechandphone1"
                                                                    Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="True" ErrorMessage="Enter Handphone1" />
                                                            </td>
                                                            <td width="10%">
                                                                Handphone 2
                                                            </td>
                                                ...
                                                <div id="divseccontactedit" runat="server">
                                                    <table class="table table-striped table-bordered table-advance table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator23" ControlToValidate="ddlsecgender"
                                                        ...
                                                        <tr>
                                                            <td width="10%">
                                                                Handphone 1
                                                                <asp:Label ID="label90" runat="server" Text=" *" ForeColor="#FF3300"></asp:Label>
                                                            </td>
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtsechandphone1edit" runat="server" Width="86%" placeholder="Handphone 1"
                                                                    ValidationGroup="Grplead3" MaxLength="18"></asp:TextBox>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator66" ControlToValidate="txtsechandphone1edit"
                                                                    Text="#" runat="server" ValidationGroup="Grplead3" SetFocusOnError="True" ErrorMessage="Enter Handphone1" />
                                                            </td>
                                                            <td width="10%">
                                                                Handphone 2
                                                            </td>
                                                    ...
                                                    <div class="well" style="text-align: center; background-color: #F0F0F0">
                                                        <button class="btn btn-app btn-success btn-mini radius-4" id="btnSubmitSecconedit"
                                                            runat="server" validationgroup="Grplead3">
                                                            Save
                                                        </button>
                                                ...
                                                <div class="well" style="text-align: center; background-color: #F0F0F0" id="divstdparinfo"
                                                    runat="server">
                                                    <button class="btn btn-app btn-primary btn-mini radius-4" id="btnstep2prev" runat="server"
                                                        onserverclick="btnstep2prev_ServerClick">
                                                        Back</button>
                                            ...
                                            <div id="divsubjectpreference" runat="server">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddlstream" Enabled="false" runat="server" data-placeholder="Select"
                                                                        CssClass="chzn-select" AutoPostBack="true" ValidationGroup="val2" data-trigger="hover"
                                                                        data-placement="top" data-content="Select Stream" OnSelectedIndexChanged="ddlstream_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:DataList ID="dlcompulsorylanguages" Enabled="false" runat="server" Width="100%"
                                                            CssClass="table table-striped table-bordered table-hover">
                                                            <HeaderTemplate>
                                                                <b>Sr. No</b></th>
                                                                <th>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtpref" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "preference")%>'
                                                                    ...
                                                                    <asp:CompareValidator ID="comparevalidator2" runat="server" ControlToValidate="txtpref"
                                                                        ...
                                                                        Text="#" SetFocusOnError="true" ErrorMessage="Please enter attempts greater than 0"></asp:CompareValidator>
                                                                    <%-- <td><asp:Label ID="lblmaterialcode" Text ='<%#DataBinder.Eval(Container.DataItem, "SGR_Material")%>' runat="server" Visible ="false" ></asp:Label>
                                                                    --%>
                                                            </ItemTemplate>
                                                        </asp:DataList>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:DataList ID="dlspecialization" Enabled="false" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover">
                                                            <HeaderTemplate>
                                                                <b>Sr. No</b></th>
                                                                <th>
                                                                    Product Name
                                            ...
                                            <div id="divMiscellaneous" runat="server">
                                                <div class="row-fluid">
                                                    <div class="col-md-12 ">
                                                        <table class="table table-striped table-bordered table-advance table-hover">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtLastSchname" Enabled="false" runat="server" Placeholder="School Name"
                                                                        Width="86%" ValidationGroup="Val4" data-trigger="hover" data-placement="top"
                                                                        data-content="Enter Student Last attended School Name"> </asp:TextBox>
                                                                    ...
                                                                    --%><asp:RegularExpressionValidator ID="RegularExpressionValidator54" runat="server"
                                                                        ControlToValidate="txtLastSchname" ErrorMessage="Please input alphabets" ValidationGroup="Val4"
                                                                        Text="#" SetFocusOnError="true" ValidationExpression="^[a-zA-Z]+[ a-zA-Z-_]*$" />
                                                                </td>
                                                                <td width="10%">
                                                                    City / Place
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtschoolplacename" Enabled="false" runat="server" Width="86%" ValidationGroup="Val4"
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtschoolexactlocation" Enabled="false" runat="server" Width="86%"
                                                                        ValidationGroup="Val4" Placeholder="School Exact Locality" data-trigger="hover"
                                                                        data-placement="top" data-content="Enter Student School Exact Locality"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddlmediumofinstruction" Enabled="false" runat="server" data-placeholder="Select"
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtlastexampassed" Enabled="false" runat="server" Width="86%" ValidationGroup="Val4"
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtlastexampassstate" Enabled="false" runat="server" Width="86%"
                                                                        ValidationGroup="Val4" Placeholder="Last Exam Passed State" data-trigger="hover"
                                                                        data-placement="top" data-content="Enter Last Exam passed State"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtnoofattempts" Enabled="false" runat="server" MaxLength="1" ValidationGroup="Val4"
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddlyearofpassing" Enabled="false" runat="server" data-placeholder="Select"
                                                                        CssClass="chzn-select" ValidationGroup="Val4" data-trigger="hover" data-placement="top"
                                                                        data-content="Select Year of Passing">
                                                                    </asp:DropDownList>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddlMonthofpassing" Enabled="false" runat="server" data-placeholder="Select"
                                                                        CssClass="chzn-select" ValidationGroup="Val4" data-trigger="hover" data-placement="top"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="Txtregistrationno" Enabled="false" runat="server" Width="86%" ValidationGroup="Val4"
                                                                ...
                                                                <td width="10%" colspan="2">
                                                                    <button type="button" class="btn btn-app btn-primary btn-mini radius-4" visible="false"
                                                                        id="btnaddmarks" onserverclick="btnaddmarks_ServerClick" runat="server">
                                                        ...
                                                        <div class="row-fluid">
                                                            <div class="col-md-8 ">
                                                                ...
                                                                <asp:DataList ID="dlsubjectmarks" Enabled="false" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover">
                                                                    <HeaderTemplate>
                                                                        <b>Subject</b></th>
                                                                        <th>
                                                                            Max. Marks
                                                    ...
                                                    <table class="table table-striped table-bordered table-advance table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="15%">
                                                                    <button type="button" class="btn btn-app btn-primary btn-mini radius-4" visible="false"
                                                                        id="btnaddextraactivity" runat="server" onserverclick="btnaddextraactivity_ServerClick">
                                                    ...
                                                    <div id="divextraactivity" runat="server" style="height: 200px; overflow: Auto">
                                                        <table class="table table-striped table-bordered table-advance table-hover">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>
                                                                    <td colspan="4">
                                                                        <button class="btn btn-app btn-success btn-mini radius-4" id="btnextraactsave" runat="server"
                                                                            validationgroup="Val41" onserverclick="btnextraactsave_ServerClick">
                                                                            Save
                                                                        </button>
                                                                        <button class="btn btn-app btn-primary btn-mini radius-4" id="btnextraactcancel"
                                                                            runat="server" onserverclick="btnextraactcancel_ServerClick">
                                                                            Close
                                                                        </button>
                                                    ...
                                                    <asp:DataList ID="dlextracurricular" Enabled="false" runat="server" Width="100%"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <asp:DropDownList ID="ddlstay" runat="server" data-placeholder="Select" CssClass="chzn-select"
                                                                    Enabled="false" ValidationGroup="Val4" data-trigger="hover" data-placement="top"
                                                                    data-content="Select Student Current Stay" data-original-title="Stay">
                ...
                <ContentTemplate>
                    ...
                    <div class="well" style="text-align: center; background-color: #F0F0F0" id="divsubmitbuttons"
                        ...
                        <button class="btn btn-app btn-success btn-mini radius-4" id="btnFormsubmit" runat="server"
                            validationgroup="Val4" visible="false">
                            Save</button>
