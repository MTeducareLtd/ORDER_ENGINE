...
public partial class Add_Contacts : System.Web.UI.Page
{
    ...
    private void School_College()
    {
        DataSet ds = ProductController.GetAllActiveSchoolContact();
        BindDDL(ddlnameofinstitution, ds, "School_Name", "School_id");
        ddlnameofinstitution.Items.Insert(0, "Select");
        ddlnameofinstitution.SelectedIndex = 0;
    }

    private void Exam()
    {
        DataSet ds = ProductController.GetallactiveExam();
        BindDDL(ddlexamname, ds, "Exam_Description", "Exam_Id");
        ddlexamname.Items.Insert(0, "Select");
        ddlexamname.SelectedIndex = 0;
    }

    protected void ddlexamname_SelectedIndexChanged(object sender, System.EventArgs e)
    {
        BindExamStatus();
    }

    private void BindExamStatus()
    {
        DataSet ds = ProductController.GetallExamStatusbyExam(ddlexamname.SelectedValue);
        BindDDL(ddlexamstatus, ds, "Exam_Status_Description", "Exam_Status_Id");
        ddlexamstatus.Items.Insert(0, "Select");
    ...
    private void Fill_Grid_AcadInfo()
    {
        ...
        _with1.Columns.Add("examnameid");
        _with1.Columns.Add("examstatusid");
        _with1.Columns.Add("examrank");
        _with1.Columns.Add("nameofinstitutionid");
    ...
    protected void btnSaveAcadInfo_ServerClick(object sender, EventArgs e)
    {
        ...
        foreach (DataListItem item in dlAcadInfo.Items)
        {
            ...
            Label lblexamnameid = (Label)item.FindControl("lblexamnameid");
            Label lblexamstatusid = (Label)item.FindControl("lblexamstatusid");
            Label lblexamrank = (Label)item.FindControl("lblexamrank");
            Label lblnameofinstitutionid = (Label)item.FindControl("lblnameofinstitutionid");
            ...
            NewRow["examnameid"] = lblexamnameid.Text;
            NewRow["examstatusid"] = lblexamstatusid.Text;
            NewRow["examrank"] = lblexamrank.Text;
            NewRow["nameofinstitutionid"] = lblnameofinstitutionid.Text;
        ...
        NewRow["InstitutionName"] = ddlnameofinstitution.SelectedItem.Text;
        ...
        NewRow["ExamName"] = ddlexamname.SelectedValue;
        ...
        NewRow["RowNumber"] = i.ToString();
        NewRow["nameofinstitutionid"] = ddlnameofinstitution.SelectedValue;
        NewRow["examnameid"] = ddlexamname.SelectedValue;
        NewRow["examstatusid"] = ddlexamstatus.SelectedValue;
        NewRow["examrank"] = txtexamrank.Text;
        dtCorrectEntry.Rows.Add(NewRow);
    ...
    protected void btnUpdateAcadInfo_ServerClick(object sender, EventArgs e)
    {
        ...
        foreach (DataListItem item in dlAcadInfo.Items)
        {
            ...
            if (lblPKeyRowNumber.Text == lblRowNumber.Text)
            {
                NewRow["InstitutionTypeCode"] = ddlinstitutiontype.SelectedValue;
                NewRow["InstitutionType"] = ddlinstitutiontype.SelectedItem.ToString();
                NewRow["InstitutionName"] = ddlnameofinstitution.SelectedValue;
                NewRow["BoardId"] = ddlboard.SelectedValue;
                NewRow["BoardName"] = ddlboard.SelectedItem.ToString();
                NewRow["standrdCode"] = ddlcurrentstudying.SelectedValue;
                NewRow["standardName"] = ddlcurrentstudying.SelectedItem.ToString();
        ...
        else if (e.CommandName == "Edit")
        {
            ...
            foreach (DataListItem item in dlAcadInfo.Items)
            {
                ...
                {                    
                    ...
                    //ddlnameofinstitution.SelectedItem.Text = lblInstitutionName.Text;
                    ddlnameofinstitution.SelectedValue = lblnameofinstitutionid.Text;
                    //ddlnameofinstitution_SelectedIndexChanged(source, e);
                    ddlexamname.SelectedValue = lblexamnameid.Text;
                    ddlexamname_SelectedIndexChanged(source, e);
                    if (lblexamstatusid.Text == "")
                    {
                        ddlexamstatus.SelectedValue = "Select";
                    }
                    else
                    {
                        ddlexamstatus.SelectedValue = lblexamstatusid.Text;
                    }
                    ...
                    txtexamrank.Text = txtexamrank.Text;
    ...
    protected void btnSubmitcon_ServerClick(object sender, System.EventArgs e)
    {
        ...
        string Institution_Type_Id = "", Institution_Type_Desc = "", Institution_Desc = "", Board_Id = "", Board_Desc = "", Cur_Standard_Id = "", Cur_Standard_Desc = "",
                 ...
                 FinalMarksObt = "", FinalMarksTotal = "", Grade = "", Percentage = "", examid = "", Exam_Status_Id = "",
                 Exam_Status_Desc = "", Exam_Rank = "", School_College_Id = "";
        foreach (DataListItem item in dlAcadInfo.Items)
        {
            Label lblInstitutionTypeCode = (Label)item.FindControl("lblInstitutionTypeCode");
            Label lblInstitutionType = (Label)item.FindControl("lblInstitutionType");
            ...
            examid = examid + lblexamnameid.Text + ",";
            Exam_Status_Id = Exam_Status_Id + lblexamstatusid.Text + ",";
            Exam_Rank = Exam_Rank + txtexamrank.Text + ",";
            School_College_Id = School_College_Id + lblnameofinstitutionid.Text + ",";
        ...
        ds = ProductController.Insert_Contacts_Detail(ddlContactsourceadd.SelectedValue,ddlContactType.SelectedValue, ddlContactType.SelectedItem.ToString(), ddlcustomertype.SelectedValue, ddlcustomertype.SelectedItem.ToString(), ddlTitle.SelectedItem.ToString(), txtFirstName.Text.Trim(), txtMidName.Text.Trim(), txtLastName.Text.Trim(),
                                                    ...
                                                    SecCon_Landline, SecCon_EmailId, SecCon_Gender, SecCon_Occupation, SecCon_Organization, SecCon_Designation, SecCon_OfficePhone, UserID, "1", examid,Exam_Status_Id,Exam_Rank,School_College_Id);
    ...
    {
        Response.Redirect("Convert_Contact_To_Lead.aspx?&Con_id=" + lblPKeyContactId.Text + "&flag=1");
