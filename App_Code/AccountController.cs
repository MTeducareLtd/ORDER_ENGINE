...
namespace ShoppingCart.BL
{
    public class AccountController
    {
       ...
       string Doc_type, int Flag, string Stream, string Materialtype, string orderid)
        ...
        public static DataSet Get_Account_Search_Results_Payment(string StudentName, string Applicationno, string Company, string Division, string Zone, string Center, string Academicyear, string Stream, string Userid, string Customer_Type,
        string Institutiontype, string Boardid, string Standard, string Mobile, string Country, string State, string City, string Location, string Productcategory, string Fromdate,
        string Todate, string OrderStatus, string Sbentrycode, string Active, string Promoted)
        {
            SqlParameter p = new SqlParameter("@StudentName", SqlDbType.NVarChar);
            ...
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_Get_Account_Search_Results_Payment", p, p1, p2, p3, p4, p5, p6,
            p7, p8, p9, p10, p11, p12, p13, p14, p15, p16,
            p17, P18, p19, p20, p21, p22, p23, p24));
        }
        ...
        public static string CreateAccount(string Oppid, string MaterialCode, string Documenttype, string Paytype, string Userid, int flag2)
        {
            ...
            p[6] = new SqlParameter("@Account_OUT_ID", SqlDbType.NVarChar, 100);
            p[6].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Insert_Ttables_New", p);
            return (p[5].Value.ToString());
        }
        ...
        public static string Insertrequest(int Flag, string Requesttypecode, string SBEntrycode, string Conditiontype, string CenterRemarks, decimal Amount, int Levelno, string Reasoncode, string Userid, string RefundApplicable, string InternalRefund)
        {
            ...
            p[6].Value = Levelno;
            p[7] = new SqlParameter("@DiscountReason", SqlDbType.VarChar,300);
            p[7].Value = Reasoncode;
            p[8] = new SqlParameter("@userid", SqlDbType.VarChar);
            p[8].Value = Userid;
            p[9] = new SqlParameter("@Refundaplicable", SqlDbType.VarChar);
            p[9].Value = RefundApplicable;
            p[10] = new SqlParameter("@IsinternalRefund", SqlDbType.VarChar);
            p[10].Value = InternalRefund;
            p[11] = new SqlParameter("@Req_Alert", SqlDbType.NVarChar, 100);
        ...
        public static DataSet Resetpassword(string UserCode, string Resetpassword)
        {
            SqlParameter p1 = new SqlParameter("@UserCode", UserCode);
            SqlParameter p2 = new SqlParameter("@Password", Resetpassword);
            return(SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_Reset_password", p1, p2));
        }
      ...
      string Todate, string OrderStatus, string Sbentrycode, string Active, string Promoted)
        ...
        public static DataSet GetCustomerdetailsbyOppid_Migration(string SBEntrycode)
        {
            SqlParameter p1 = new SqlParameter("@Oppid", SBEntrycode);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "[USP_GETALLDETAILSBYOPPID_MIGRATION]", p1));
        }

        public static DataSet GetOppSearchforMigration(string StudentName, string Applicationno, string Company, string Division, string Zone, string Center, string Academicyear, string Stream, string Userid, string Customer_Type,
        string Institutiontype, string Boardid, string Standard, string Mobile, string Country, string State, string City, string Location, string Productcategory, string Fromdate,
        string Todate, string OrderStatus, string Sbentrycode, string Active, string Promoted)
        {
            SqlParameter p = new SqlParameter("@StudentName", SqlDbType.NVarChar);
            ...
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "[USP_Get_Opp_Search_Results_For_Migration]", p, p1, p2, p3, p4, p5, p6,
            p7, p8, p9, p10, p11, p12, p13, p14, p15, p16,
            p17, P18, p19, p20, p21, p22, p23, p24));
        }
        ...
        public static DataSet GetPkey()
        {
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GEPPKEYFORSYNC"));
        }
        ...
        /// <returns></returns>
        public static DataSet GetLoan_ForDispatch(string Flag, string Center)
        {
            SqlParameter p1 = new SqlParameter("@Flag", Flag);
            SqlParameter p2 = new SqlParameter("@Centre_Code", Center);

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetLoanDispatchStudentByCenter", p1, p2));
        }


        public static string InsertLoanDispatchslip_details(string Flag, string LoanDispatchSlipCode, string Center_Code, string LoanDispatchSlipNo, string LoanDispatchDate, string LoanCnt,
            string LoanValue, string SBEntrycode, string UserId)
        {
            SqlParameter p1 = new SqlParameter("@Flag", Flag);
            SqlParameter p2 = new SqlParameter("@LoanDispatchSlipCode", LoanDispatchSlipCode);
            SqlParameter p3 = new SqlParameter("@Center_Code", Center_Code);
            SqlParameter p4 = new SqlParameter("@LoanDispatchSlipNo", LoanDispatchSlipNo);
            SqlParameter p5 = new SqlParameter("@LoanDispatchDate", LoanDispatchDate);
            SqlParameter p6 = new SqlParameter("@LoanCnt", LoanCnt);
            SqlParameter p7 = new SqlParameter("@LoanValue", LoanValue);
            SqlParameter p8 = new SqlParameter("@SBEntrycode", SBEntrycode);
            SqlParameter p9 = new SqlParameter("@Created_By", UserId);

            return Convert.ToString(SqlHelper.ExecuteScalar(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Insert_Update_LoanDocumentDispatch", p1, p2, p3, p4, p5, p6, p7, p8, p9));
        }


        public static DataSet GetLoanDispatchSlip(string Division, string Center, string Fromdate, string Todate, string Userid, string Slipno)
        {
            SqlParameter p1 = new SqlParameter("@division", Division);
            SqlParameter p2 = new SqlParameter("@center", Center);
            SqlParameter p3 = new SqlParameter("@fdate", Fromdate);
            SqlParameter p4 = new SqlParameter("@tdate", Todate);
            SqlParameter p5 = new SqlParameter("@User_Id", Userid);
            SqlParameter p6 = new SqlParameter("@slipno", Slipno);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_GetLoanDispatchSlip", p1, p2, p3, p4, p5, p6));
        }

        public static DataSet GetLoanDispatchDetailsbySlipno(int Flag, string LoanDispatchSlipNo)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@Flag", SqlDbType.Int);
            p[0].Value = Flag;
            p[1] = new SqlParameter("@LoanDispatchSlipNo", SqlDbType.NVarChar);
            p[1].Value = LoanDispatchSlipNo;
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Get_LoanDispatchSlipDetails", p));
        }

        public static DataSet GetStudentLoanDetails(int Flag, string SbEntryCode)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@Flag", SqlDbType.Int);
            p[0].Value = Flag;
            p[1] = new SqlParameter("@SbEntryCode", SqlDbType.NVarChar);
            p[1].Value = SbEntryCode;
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Get_StudentLoanDetails", p));
        }
        ...
        /// <param name="SBEntrycode"></param>
        /// <returns></returns>
        public static string InsertP20(string SBEntrycode)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@SBENTRYCODE", SqlDbType.NVarChar);
            p[0].Value = SBEntrycode;
            p[1] = new SqlParameter("@recptid", SqlDbType.NVarChar, 100);
            p[1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_insert_P20", p);
            return (p[1].Value.ToString());
        }
        public static string InsertE20(string SBEntrycode)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@SBENTRYCODE", SqlDbType.NVarChar);
            p[0].Value = SBEntrycode;
            p[1] = new SqlParameter("@recptid", SqlDbType.NVarChar, 100);
            p[1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_insert_E20", p);
            return (p[1].Value.ToString());
        }
        ...
        /// <param name="LoanAppStatus"></param>
        /// <param name="Userid"></param>
        /// <returns></returns>
        public static DataSet GetLoanApprovalStudent(string Division, string LoanAppStatus, string Userid)
        {
            SqlParameter p1 = new SqlParameter("@division", Division);
            SqlParameter p2 = new SqlParameter("@LoanAppStatus", LoanAppStatus);
            SqlParameter p3 = new SqlParameter("@User_Id", Userid);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_GetLoanApprovalStudent", p1, p2, p3));
        }

        public static DataSet GetLoanApprovalStudentBySBEntryCode(string SBEntryCode)
        {
            SqlParameter p1 = new SqlParameter("@SBEntryCode", SBEntryCode);

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_GetLoanApprovalStudent_BySBEntryCode", p1));
        }

        public static string InsertLoan_ApprovalStud(string SBEntryCode, string LoanApplicationStatus, decimal ApprovalLoanAmount, string Remarks, string Loan_Receipt_Num, string Userid)
        {
            SqlParameter[] p = new SqlParameter[7];
            p[0] = new SqlParameter("@SBEntryCode", SqlDbType.VarChar);
            p[0].Value = SBEntryCode;
            p[1] = new SqlParameter("@LoanApplicationStatus", SqlDbType.VarChar);
            p[1].Value = LoanApplicationStatus;
            p[2] = new SqlParameter("@ApprovalLoanAmount", SqlDbType.Decimal);
            p[2].Value = ApprovalLoanAmount;
            p[3] = new SqlParameter("@userid", SqlDbType.NVarChar);
            p[3].Value = Userid;
            p[4] = new SqlParameter("@Remarks", SqlDbType.NVarChar);
            p[4].Value = Remarks;
            p[5] = new SqlParameter("@Loan_Receipt_Num", SqlDbType.NVarChar);
            p[5].Value = Loan_Receipt_Num;

            p[6] = new SqlParameter("@SBEntryCodeOP", SqlDbType.NVarChar, 100);
            p[6].Direction = ParameterDirection.Output;

            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_InsertLoan_ApprovalStudent", p);
            return (p[6].Value.ToString());
        }

        public static DataSet GetLoanPaymentDetailsbySBEntrycode(string SBEntrycode)
        {
            SqlParameter p1 = new SqlParameter("@SBEntrycode", SBEntrycode);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GETLOANRECEIPTBYSBENTRYCODE", p1));
        }


        //16 Oct 2015
        public static string UpdateRequestWithCancellationAmount(string SBEntrycode, string Requesttypecode, string Center, int Status, string Appremarks, decimal Amount, string Userid, string Requestid, string CRF_Amount, string Robomate_Amount)
        {
            ...
            p[8] = new SqlParameter("@Request_id", SqlDbType.VarChar);
            p[8].Value = Requestid;
            p[9] = new SqlParameter("@CRF_Amount", SqlDbType.VarChar);
            p[9].Value = CRF_Amount;
            p[10] = new SqlParameter("@Robomate_Amount", SqlDbType.VarChar);
            p[10].Value = Robomate_Amount;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_UPDATEREQUEST", p);
            return (p[7].Value.ToString());
        }

        public static DataSet GetEventAfterCourseDuration(string User_Code)
        {
            SqlParameter p1 = new SqlParameter("@User_code", User_Code);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_get_AllowEventPostCourse_Duration", p1));
        }


        public static string GetSBEntrycodebyOppid(string Oppid)
        {
            SqlParameter[] p = new SqlParameter[2];
            ...
            p[1] = new SqlParameter("@code", SqlDbType.NVarChar, 100);
            p[1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GET_SBENTRYCODE_BY_OPPID", p);
            return (p[1].Value.ToString());
        }

        public static string PopulateP01forManageOrder(string SBEntrycode)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@SBENTRYCODE", SqlDbType.VarChar);
            p[0].Value = SBEntrycode;
            p[1] = new SqlParameter("@recptid", SqlDbType.NVarChar, 100);
            p[1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_insert_payment_P01", p);
            return (p[1].Value.ToString());
        }


        public static string ValidateConfirmAdmission(int Flag, string SBEntrycode)
        {
            SqlParameter[] p = new SqlParameter[3];
            p[0] = new SqlParameter("@Flag", SqlDbType.Int);
            p[0].Value = Flag;
            p[1] = new SqlParameter("@SbEntryCode", SqlDbType.VarChar);
            p[1].Value = SBEntrycode;
            p[2] = new SqlParameter("@Verify_Output", SqlDbType.NVarChar, 100);
            p[2].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Verify_Rule_Confirm_Admission", p);
            return (p[2].Value.ToString());
        }

        public static string ForceConfirmAdmission(string SBEntrycode)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@SBENTRYCODE", SqlDbType.VarChar,50);
            p[0].Value = SBEntrycode;
            p[1] = new SqlParameter("@recptid", SqlDbType.NVarChar, 100);
            p[1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_insert_payment_NEW_LFCPL", p);
            return (p[1].Value.ToString());
        }
        ...
        public static DataSet Update_ECS_Acknowledgement(string User_Code, string Flag, string ECSID,string DeclineReason)
        {            
            SqlParameter p1 = new SqlParameter("@Flag", Flag);
            SqlParameter p2 = new SqlParameter("@ECSID", ECSID);
            SqlParameter p3 = new SqlParameter("@UserId", User_Code);
            SqlParameter p4 = new SqlParameter("@DeclineReason", DeclineReason);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_Update_ECS_Acknowledge", p1, p2, p3,p4));
        }


        public static DataSet Get_ECS_Dispatch_Export(string User_Code, string Flag, string ECSID)
        {
            SqlParameter p1 = new SqlParameter("@Flag", Flag);
            SqlParameter p2 = new SqlParameter("@ECSID", ECSID);
            SqlParameter p3 = new SqlParameter("@UserID", User_Code);

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_Get_ECS_Dispatch_Detail_Export", p1, p2, p3));
        }

        public static string Get_ECS_Slipno(int Flag, string Center, string Userid, string Slip, string Payeeid, string Paymode)
        {
            SqlParameter[] p = new SqlParameter[6];
            p[0] = new SqlParameter("@flag", SqlDbType.Int);
            p[0].Value = Flag;
        ...
        public static DataSet Get_ECS_Cheques_ForDispatch(int Flag, string Center, string Userid, string Slip, string Payeeid, string Paymode, string ECS_Date,string Division)
        {
            SqlParameter p1 = new SqlParameter("@flag", Flag);
            SqlParameter p2 = new SqlParameter("@userid", Userid);
            SqlParameter p3 = new SqlParameter("@center", Center);
            ...
            SqlParameter p5 = new SqlParameter("@Payeeid", Payeeid);
            SqlParameter p6 = new SqlParameter("@paymode", Paymode);
            SqlParameter p7 = new SqlParameter("@ECS_Date", ECS_Date);
            SqlParameter p8 = new SqlParameter("@Division", Division);
            
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Get_ECS_Cheques_ForDispatch", p1, p2, p3, p4, p5, p6, p7, p8));
        }

        public static string Insert_ECSDispatchslip_details(int Flag, string DispatchSlipCode, string Center_Code, string Division_Code, string DispatchDate, int ChequeCnt,
            decimal ChequeValue, int PrintFlag, string Payeeid, string UserId, string ChequeIDNo)
        {
            SqlParameter[] p = new SqlParameter[12];
            p[0] = new SqlParameter("@Flag", SqlDbType.Int);
            ...
            p[11] = new SqlParameter("@slipid", SqlDbType.NVarChar, 100);
            p[11].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Insert_ECS_Dispatchslip_details", p);
            return (p[11].Value.ToString());
        }

        public static DataSet Get_ECS_DispatchSlip(string Company, string Division, string Zone, string Center, string Fromdate, string Todate, string Userid, string Payeeid, string Slipno)
        {
            SqlParameter p1 = new SqlParameter("@company", Company);
            SqlParameter p2 = new SqlParameter("@division", Division);
            SqlParameter p3 = new SqlParameter("@zone", Zone);
            ...
            SqlParameter p8 = new SqlParameter("@payee_id", Payeeid);
            SqlParameter p9 = new SqlParameter("@slipno", Slipno);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Get_ECS_DispatchSlip", p1, p2, p3, p4, p5, p6, p7,
            p8, p9));
        }

        public static DataSet GetRequestEneblebyuser(string Usercode)
        {
            SqlParameter p1 = new SqlParameter("@usercode", Usercode);
           return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Get_request_eneble_byuser", p1));
        }

        public static DataSet Getstudentpendingreasonbysbentrycode(string SBEntrycode)
        {
            SqlParameter p1 = new SqlParameter("@sbentrycode", SBEntrycode);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usb_Fill_Addmission_Pending_Remarks", p1));
        }
        // added for stream change bulk--20-09-2019

        public static DataSet GetSbentrycodeforstreamchange()
        {

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Get_sbenetrocde_For_streamchange"));
        }

        public static void InserttoGetPricingprocedurevaluebyoppidStreamChangeBulk(string Oppid, string Materialcode, string Voucher_type, string centercode, string Stream)
        {
            SqlParameter p1 = new SqlParameter("@oppid", Oppid);
            SqlParameter p2 = new SqlParameter("@materialcode", Materialcode);
            SqlParameter p3 = new SqlParameter("@Voucher_Typ", Voucher_type);
            SqlParameter p4 = new SqlParameter("@CenterCode", centercode);
            SqlParameter p5 = new SqlParameter("@Stream", Stream);
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Get_MaterialCode_ForNew_stream", p1, p2, p3, p4, p5);
        }

        public static DataSet GetTaxValue_forstreamchange(int flag, string Sbentrycode, string Centercode)
        {
            SqlParameter p = new SqlParameter("@Flag", SqlDbType.Int);
            p.Value = flag;
            ...
            p3.Value = Centercode;
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_Get_Tax_Value_by_Amt_new streamchnge_bulk", p, p1, p3));
        }

        public static void EventSTSConfrim(string OldSBEntrycode)
        {
            SqlParameter p1 = new SqlParameter("@OldSBentrycode", OldSBEntrycode);
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_AUTO_CONFIRM_ADMISSION_Bulkstreamchange", p1);
        }

        public static DataSet GetCustomerdetailsSbentrycode(string SBEntrycode)
        {
            SqlParameter p1 = new SqlParameter("@SBEntrycode", SBEntrycode);
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GETALLDETAILSBYSBENTRYCODE_New", p1));
        }

        public static string Verify_CCDCEntry(string CCDCdate)
        {
            SqlParameter[] p = new SqlParameter[2];
            p[0] = new SqlParameter("@CCDCdate", SqlDbType.VarChar);
            p[0].Value = CCDCdate;
            p[1] = new SqlParameter("@Verify_Output", SqlDbType.VarChar, 100);
            p[1].Direction = ParameterDirection.Output;
            SqlHelper.ExecuteNonQuery(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Verify_CCDCEntry_date", p);
            return (p[1].Value.ToString());
        }
    }
}
