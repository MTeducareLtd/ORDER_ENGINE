...
namespace ShoppingCart.BL
{
    public class UserController
    {
        ...
        public static DataSet Get_Opportunity_Search_Results_New_New(string Company, string Division, string Zone, string Center, string Customertype, string Institutiontype, string Boardid, string Standard, string Name, string Mobile,
        string Country, string State, string City, string Location, string Acadyear, string Productcategory, string Stream, string Applicationno, string Salesstage, string opp_from,
        string opp_to, string Followup_from, string Followup_to, string Followupoverdue, string Last_Followupoverdays, string Joining_from, string Joining_to, string Boardid1, string Year, string Agg_score,
        int Area_rank, int Overall_Rank, string Userid, string Scoretype, string Condition, string Score, string agefrom, string ageto, string Blocked, string xam_details,
        string Stage, string gender, string Orderby)
        {
            ...
            //Dim p42 As New SqlParameter("@orderby", SqlDbType.NVarChar)
            //p42.Value = Orderby
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetOpportunity_SearchResults_New", p, p1, p2, p3, p4, p5, p6,
            p7, p8, p9, p10, p11, p12, p13, p14, p15, p16,
            p17, p18, p19, p20, p21, p22, p23, p24, p25, p26,
            p27, p28, p29, p30, p31, p32, p33, p34, p35, p36,
            p37, p38, p39, p40, p41));
        ...
        public static DataSet Get_Opportunity_Search_Results_New_New_New(string Company, string Division, string Zone, string Center, string Customertype, string Institutiontype, string Boardid, string Standard, string Name, string Mobile,
        string Country, string State, string City, string Location, string Acadyear, string Productcategory, string Stream, string Applicationno, string Salesstage, string opp_from,
        string opp_to, string Followup_from, string Followup_to, string Followupoverdue, string Last_Followupoverdays, string Joining_from, string Joining_to, string Boardid1, string Year, string Agg_score,
        int Area_rank, int Overall_Rank, string Userid, string Scoretype, string Condition, string Score, string agefrom, string ageto, string Blocked, string xam_details,
        string Stage, string gender, string Orderby)
        {
            ...
            //Dim p42 As New SqlParameter("@orderby", SqlDbType.NVarChar)
            //p42.Value = Orderby
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetOpportunity_SearchResults_New_New", p, p1, p2, p3, p4, p5, p6,
            p7, p8, p9, p10, p11, p12, p13, p14, p15, p16,
            p17, p18, p19, p20, p21, p22, p23, p24, p25, p26,
            p27, p28, p29, p30, p31, p32, p33, p34, p35, p36,
            p37, p38, p39, p40, p41));
        ...
        public static DataSet Get_EComSalesOpportunity_Search_Results_New_New_New(string Company, string Division, string Zone, string Center, string Customertype, string Institutiontype, string Boardid, string Standard, string Name, string Mobile,
        string Country, string State, string City, string Location, string Acadyear, string Productcategory, string Stream, string Applicationno, string Salesstage, string opp_from,
        string opp_to, string Followup_from, string Followup_to, string Followupoverdue, string Last_Followupoverdays, string Joining_from, string Joining_to, string Boardid1, string Year, string Agg_score,
        int Area_rank, int Overall_Rank, string Userid, string Scoretype, string Condition, string Score, string agefrom, string ageto, string Blocked, string xam_details,
        string Stage, string gender, string Orderby)
        {
            ...
            //Dim p42 As New SqlParameter("@orderby", SqlDbType.NVarChar)
            //p42.Value = Orderby
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetEComSalesOpportunity_SearchResults_New_New", p, p1, p2, p3, p4, p5, p6,
            p7, p8, p9, p10, p11, p12, p13, p14, p15, p16,
            p17, p18, p19, p20, p21, p22, p23, p24, p25, p26,
            p27, p28, p29, p30, p31, p32, p33, p34, p35, p36,
            p37, p38, p39, p40, p41));
