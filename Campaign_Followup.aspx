<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Campaign_Followup.aspx.cs" Inherits="Campaign_Followup" %>
                                            ...
                                            <div class="row-fluid" runat="server" id="divConInfo" visible="false">
                                                <div class="widget-box">
                                                    <div class="widget-header">
                                                        ...
                                                        <asp:Label ID="lblRecNo" runat="server" Visible="false"></asp:Label>
                                                                ...
                                                                <table class="table table-striped table-bordered table-advance table-hover" id="Table1"
                                                                    ...
                                                                    <tr id="tr1" runat="server" visible="false">
                                                                        ...
                                                                        <td width="20%">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator26" ControlToValidate="txtdate"
                                                                                Text="#" runat="server" ValidationGroup="Grplead" SetFocusOnError="True" ErrorMessage="Enter the date of Interaction" />
                                                                            <asp:Label ID="lbldateerrorInteracted" runat="server" ForeColor="#FF3300"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr id="tr2" runat="server" visible="false">
                                                                        <td>
                                                                            Campaign Followup Status
                                                                            <asp:Label ID="lblFeddbackStatusValidation" runat="server" Text=" *" ForeColor="#FF3300"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlCampaignFollowupStatus" runat="server" CssClass="chzn-select"
                                                                                ValidationGroup="Grplead">
                                                                            </asp:DropDownList>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlCampaignFollowupStatus"
                                                                                Text="#" runat="server" ValidationGroup="Grplead" SetFocusOnError="True" ErrorMessage="Select Campaign Followup Status"
                                                                                InitialValue="Select" />
                                                                        </td>
                                                                        <td width="10%">
                                                                            Feedback
