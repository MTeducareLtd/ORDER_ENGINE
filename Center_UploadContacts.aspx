<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Center_UploadContacts.aspx.cs" Inherits="Center_UploadContacts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Upload Contacts<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
            ...
            <div id="DivAddPanel" runat="server" visible="true">
                <div class="widget-box">
                    <div class="widget-header widget-hea1der-small header-color-dark">
                        <h5>
                            <asp:Label ID="Label4" runat="server" Text="Upload Excel"></asp:Label>
                        </h5>
                        <div class="btn-group">
                    ...
                    <div class="widget-body">
                        <div class="widget-body-inner">
                            ...
                            <div class="widget-main alert-block alert-info" style="text-align: center; background-color: #F0F0F0">
                                <!--Button Area -->
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                    ...
                    <div class="table-header">
                        <table width="100%">
                            <tr>
                                ...
                                <td style="text-align: right" class="span2">
                                    <asp:LinkButton runat="server" ID="btnExportErrorContacts" ToolTip="Export Error Contacts"
                                        class="btn-small btn-danger icon-2x icon-download-alt" Height="25px" Visible="false"
                                        OnClick="btnExportErrorContacts_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </td>
                            </tr>
                        </table>
                ...
                <asp:DataList ID="dlviewExcelFormat" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                        ...
                        <td style="text-align: left">
                            <asp:Label ID="lblInstituteType" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"InstitutionType")%>' />
                        </td>
                        <td style="text-align: left">
                            <asp:Label ID="lblInstitute" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Institution")%>' />
                        </td>
                        <td style="text-align: left">
                            <asp:Label ID="lblBoard" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Board")%>' />
                        </td>
                        <td style="text-align: left">
                            <asp:Label ID="lblCurStudying" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"CurrentStudying")%>' />
                        </td>
                        <td style="text-align: left">
