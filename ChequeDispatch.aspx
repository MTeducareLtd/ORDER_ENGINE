<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ChequeDispatch.aspx.cs" Inherits="ChequeDispatch" %>
        ...
        <div id="breadcrumbs" class="position-relative">
            ...
            <div id="nav-search">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li><a id="btnmakeCMS" runat="server" onserverclick="btnmakeCMS_ServerClick">Make Dispatch
                        Slip</a> </li>
                </ul>
            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddldivision" ValidationGroup="Validation10" runat="server"
                                                        ...
                                                        <asp:DropDownList ID="ddlcompany" runat="server" Visible="false" ValidationGroup="Validation10"
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlcompany"
                                                            Text="#" runat="server" ValidationGroup="Validation10" SetFocusOnError="True"
                                                            ErrorMessage="Select Company" InitialValue="Select" Visible="false" />
                                                    </td>
                                                    <%--<td width="10%">
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlcenter" ValidationGroup="Validation10" runat="server" data-placeholder="Select"
                                                            CssClass="chzn-select">
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="ddlcenter"
                                                            Text="#" runat="server" ValidationGroup="Validation10" SetFocusOnError="True"
                                                            ErrorMessage="Select Center" InitialValue="Select" />
                                                    </td>
                                                    <td width="10%">
                                                        Payee
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlpayee" ValidationGroup="Validation10" runat="server" data-placeholder="Select"
                                                            CssClass="chzn-select">
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="ddlpayee"
                                                            Text="#" runat="server" ValidationGroup="Validation10" SetFocusOnError="True"
                                                            ErrorMessage="Select Payee" InitialValue="Select" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="10%">
                                            ...
                                            <div class="well" style="text-align: center; background-color: #F0F0F0">
                                                <button class="btn btn-app btn-primary btn-mini radius-4" id="btnsearch" validationgroup="Validation10"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkviewdetails" runat="server" class="btn btn-minier btn-primary icon-eye-open tooltip-info"
                                                                        data-rel="tooltip" data-placement="top" title="View" CommandName="Viewdetails"
                                                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"slipno")%>' Visible="false"></asp:LinkButton>
                                                                    <a href='<%#DataBinder.Eval(Container.DataItem,"Slipno","ChequeDispatch_View.aspx?&Slip_No={0}") %>'
                                                                        id="btndisplay" runat="server" target="_blank" class="btn btn-minier btn-primary icon-eye-open tooltip-info"
                                                                        data-rel="tooltip" data-placement="top" title="View"></a><a href="<%#DataBinder.Eval(Container.DataItem,"slipno","ChequeDispatch_Print.aspx?Slip_No={0}")%>"
                                                                            target="_blank" class="btn btn-minier btn-warning icon-print tooltip-warning"
                                                                            data-rel="tooltip" data-placement="top" title="Print">
                                                                            <asp:Label ID="lnkprintslip" runat="server" CommandName="PrintSlip" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"slipno")%>'></asp:Label></a>
                                                                    <asp:LinkButton ID="lbkCancelRequest" runat="server" class="btn btn-minier btn-danger icon-ban-circle tooltip-danger"
                                                                        data-rel="tooltip" data-placement="top" title="Cancel Request" CommandName="CancelRequest"
                                                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"slipno")%>' Visible="true"></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                            ...
                            <div id="Div2" class="tab-pane active">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlcenterSlip" ValidationGroup="Val1" runat="server" data-placeholder="Select"
                                                            CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlcenterSlip_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlpaymode" ValidationGroup="Val1" runat="server" data-placeholder="Select"
                                                            CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlpaymode_SelectedIndexChanged">
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlpayeeadd" ValidationGroup="Val1" runat="server" data-placeholder="Select"
                                                            CssClass="chzn-select">
                                                        </asp:DropDownList>
                                                    ...
                                                    <td width="10%">
                                                        <button class="btn btn-app btn-success btn-mini radius-4" id="btngetrecords" runat="server"
                                                            validationgroup="Val1" onserverclick="btngetrecords_ServerClick">
                                                            Get
                                                        </button>
                                                    </td>
                                                    <td width="20%">
                                ...
                                <div class="row-fluid" id="div4" runat="server">
                                    <div class="span12">
                                        ...
                                        <!-- END EXAMPLE TABLE PORTLET-->
                                        <div class="well" style="text-align: center; background-color: #F0F0F0">
                                          <%--  <button class="btn btn-app btn-success btn-mini radius-4" id="btnsave" runat="server"
                                                validationgroup="Val1" onserverclick="btnsave_ServerClick">
                                                Save
                                            </button>--%>
                                            <asp:Button ID="btnsave" runat="server" Text="Save" OnClick="btnsave_Click" class="btn btn-app btn-success btn-mini radius-4" TabIndex="-1" UseSubmitBehavior="false" OnClientClick="this.disabled=true;" />
                                            <button class="btn btn-app btn-primary btn-mini radius-4" id="btnCloseAdd" runat="server"
                                                onserverclick="btnCloseAdd_ServerClick">
                                                Close
                                            </button>
