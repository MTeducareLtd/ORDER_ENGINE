<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ContactCenter_Add_Contacts.aspx.cs" Inherits="ContactCenter_Add_Contacts" %>
        ...
        <div class="page-content">
            ...
            <div runat="server" id="divSaveMessage" class="row-fluid" visible="false">
                <div class="alert alert-success" id="div1" runat="server">
                    ...
                    <br />
                    <%--<div class="btn-group" id="divAssignContactToLead" runat="server">
                       <a id="aAssignToLead" runat="server" target="_blank" class="btn btn-small btn-success tooltip-info">                            
                            Assign To Lead
                       </a>
                    </div>--%>
                                                            ...
                                                            <div class="widget-main">
                                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                                    <tr>
                                                                        ...
                                                                        <td width="10%">
                                                                            Contact Type
                                                                            <%--<asp:Label ID="lbl3" runat="server" Text=" *" ForeColor="#FF3300"></asp:Label>--%>
                                                                        </td>
                                                                        <td width="20%">
                                                                        ...
                                                                        <td width="20%">
                                                                            <asp:DropDownList ID="ddlcustomertype" runat="server" data-placeholder="Select Type"
                                                                                Width="215px" CssClass="chzn-select" AutoPostBack="true" ValidationGroup="Grplead2" Enabled="false">
                                                                            </asp:DropDownList>
                                                                    ...
                                                                    <%--<tr>
                                                                        <td width="10%">
                                                                            Title
                                                                            <asp:Label ID="lbl5" runat="server" Text=" *" ForeColor="#FF3300"></asp:Label>
                                                                        </td>
                                                                        <td width="20%">
                                                ...
                                                <div class="span12">
                                                    <%--<div class="widget-box">
                                                        <div class="widget-header">
                                                            <h5>
                                                                <b>
                                                                    <asp:CheckBox ID="chkFatherInfo" runat="server" AutoPostBack="True" Checked="true"
                                                                        OnCheckedChanged="chkFatherInfo_CheckedChanged" />
                                                                    <span class="lbl"></span></b>&nbsp;Father Information
                                                            </h5>
                                                        </div>
                                                        <div class="widget-body">
                                                            <div class="widget-main">--%>
                                                ...
                                                <div class="span12">
                                                    <%--<div class="widget-box">
                                                        <div class="widget-header">
                                                            <h5>
                                                                <b>
                                                                    <asp:CheckBox ID="chkMotherInfo" runat="server" AutoPostBack="True" Checked="true"
                                                                        OnCheckedChanged="chkMotherInfo_CheckedChanged" />
                                                                    <span class="lbl"></span></b>&nbsp;Mother Information
                                                            </h5>
                                                        </div>
                                                        <div class="widget-body">
                                                            <div class="widget-main">--%>
                                                ...
                                                <div class="span12">
                                                    <%--<div class="widget-box">
                                                        <div class="widget-header">
                                                            <h5>
                                                                <b>
                                                                    <asp:CheckBox ID="chkGuardianInfo" runat="server" AutoPostBack="True" Checked="true" OnCheckedChanged="chkGuardianInfo_CheckedChanged" />
                                                                    <span class="lbl"></span>
                                                                </b>
