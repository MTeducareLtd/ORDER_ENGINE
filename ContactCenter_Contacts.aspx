<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ContactCenter_Contacts.aspx.cs" Inherits="ContactCenter_Contacts" %>
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        ...
        <div id="nav-search">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                <li><a href="ContactCenter_Add_Contacts.aspx" id="btnregistrationno" runat="server">Add Contact</a></li>
                <li><a href="ContactCenter_UploadContacts.aspx" id="A1" runat="server">Bulk Upload</a></li>
            </ul>
        </div>
        <!--#nav-search-->
    </div>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Con_id","ContactCenter_Contact_Edit.aspx?&Con_id={0}") %>'
                                                                    id="btnEdit" runat="server" target="_blank" class="btn btn-minier btn-primary  icon-edit tooltip-success"
                                                                    data-rel="tooltip" data-placement="top" title="Edit"></a>&nbsp; <a href='<%#DataBinder.Eval(Container.DataItem,"Con_id","ContactCenter_Convert_Contact_To_Lead.aspx?&Con_id={0}") %>'
                                                                ...
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Con_id","Contact_Followup.aspx?&Con_id={0}&Flag=100") %>'
