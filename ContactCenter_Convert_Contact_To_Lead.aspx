<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ContactCenter_Convert_Contact_To_Lead.aspx.cs" Inherits="ContactCenter_Convert_Contact_To_Lead" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="page-content" class="clearfix">
        <div class="page-content">
                                                    ...
                                                    <tr>
                                                        <td width="10%">
                                                            ...
                                                            &nbsp; <span class="help-button ace-popover" data-trigger="hover" data-placement="right"
                                                                data-content="Type of lead" title="Lead Type">?</span>
                                                        </td>
                                                        <td width="20%">
                                                    ...
                                                    <div class="widget-main">
                                                        <table class="table table-striped table-bordered table-advance table-hover" id="tblorgassign"
                                                            ...
                                                            <tr id="trtargetcompany" runat="server">
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddltargetcompanyadd" Width="215px" runat="server" AutoPostBack="true" Enabled="false"
                                                            ...
                                                            <tr id="trtargetrow2" runat="server">
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddltargetdivisionadd" Width="215px" runat="server" AutoPostBack="true" Enabled="false"
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddltargetzoneadd" Width="215px" runat="server" AutoPostBack="true" Enabled="false"
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddltargetcenteradd" Width="215px" runat="server" CssClass="chzn-select" Enabled="false"
                                                                        ValidationGroup="Grplead2">
                                                                    </asp:DropDownList>
            ...
            <%--</ContentTemplate>
                <Triggers>
                    <asp:PostBackTrigger ControlID="btnSaveConvertContactToLead" />
            ...
            <div runat="server" id="DivMessage" class="row-fluid" visible="false">
                <div class="alert alert-success" id="div1" runat="server">
                    ...
                    &nbsp;&nbsp;
                    <%--<asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="btn_ConvertToOppYes"
                        ToolTip="Yes" runat="server" Text="Yes" OnClick="btn_ConvertToOppYes_Click" />--%>
