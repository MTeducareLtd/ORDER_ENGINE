...
public partial class ContactCenter_Convert_Lead_To_Opportunity : System.Web.UI.Page
{
    ...
    private void BindAcademicYear()
    {
       ...
       // DataSet ds = ProductController.GetAcademicYearbyCenter(ddlconvertcenter.SelectedValue);
        ...
        DataSet ds = ProductController.GetAllCurrentyear();
        BindDDL(ddlConacademicyear, ds, "Description", "ID");
        ddlConacademicyear.Items.Insert(0, "Select");
        ddlConacademicyear.SelectedIndex = 0;
    }
    ...
    protected void btnopportunitysubmit_ServerClick(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            Oppor_product = txtproductInterested.Text.Trim();
            Oppor_Product_id = "1000";
            ...
            //{
                ...
                ConvertToOrder.HRef = "ContactCenter_Manage_Order.aspx?&Opportunity_Code=" + Opportunity_Code;
    ...
    {
        Response.Redirect("ContactCenter_Convert_Lead_To_Opportunity.aspx?&Lead_Code=" + Request["Lead_Code"].ToString());
    }
}