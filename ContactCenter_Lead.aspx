<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ContactCenter_Lead.aspx.cs" Inherits="ContactCenter_Lead" %>
        ...
        <div id="nav-search">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <%--<button type="button" class="btn btn-danger btn-small dropdown-toggle" id="btnaddlead"
                        runat="server" onserverclick="btnaddlead_ServerClick" visible="false">
                        Add Lead</button>--%>
                        ...
                        <div class="span12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    <tr>
                                        <td width="10%">
                                            Target Company&nbsp; <span class="help-button ace-popover" data-trigger="hover" data-placement="right"
                                                data-content="Company in which lead has been assigned" title="Target Company">?</span>
                                        </td>
                                        <td width="20%">
                                        ...
                                        <td width="20%">
                                            <asp:DropDownList ID="ddlsourcezone" runat="server" Width="215px" CssClass="chzn-select"
                                                AutoPostBack="true" OnSelectedIndexChanged="ddlsourcezone_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                           ...
                                           <%-- <asp:TextBox ID="txtfromdate" runat="server" Width="205px" ValidationGroup="Grplead1"></asp:TextBox>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget-box ">
                                <!--<div class="table-header">
                                    <div class="caption">
                                        <i class="fa fa-bell-o "></i>Lead Search Results
                                    </div>
                                </div>-->
                                <div class="widget-header widget-hea1der-small header-color-dark">
                                    ...
                                    <div class="widget-toolbar">
                                        <%--<div class="btn-group">
                                            <a class="btn btn-danger btn-mini radius-4" href="Lead_Add.aspx">Add Lead <i class="fa fa-plus">
                                            </i></a>
                                        </div>--%>
                                    </div>
                                </div>
                                <div class="widget-body">
                                    <div class="table-toolbar" id="divtoolbar" runat="server" visible="false">
                                        <div class="btn-group">
                                            <%--<a id="btnadd2" class="btn btn-app btn-white btn-mini" runat="server">Add Lead <i
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand"
                                        ...
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a href='<%#DataBinder.Eval(Container.DataItem,"Lead_Code","ContactCenter_Lead_Display.aspx?&Lead_Code={0}") %>'
                                                        ...
                                                        <a href='<%#DataBinder.Eval(Container.DataItem,"Lead_Code","ContactCenter_Lead_Edit.aspx?&Lead_Code={0}") %>'
                                                    ...
                                                    <a href='<%#DataBinder.Eval(Container.DataItem,"Lead_Code","Lead_Followup.aspx?&Lead_Code={0}&Flag=100") %>'
                                                    ...
                                                    <a href='<%#DataBinder.Eval(Container.DataItem,"Lead_Code","ContactCenter_Convert_Lead_To_Opportunity.aspx?&Lead_Code={0}") %>'
                                                    ...
                                                    <%--<asp:LinkButton ID="lnkconvert" runat="server" class="btn btn-minier btn-primary icon-check tooltip-info"
                                                        data-rel="tooltip" data-placement="top" title="Convert" CommandName="Convert"
