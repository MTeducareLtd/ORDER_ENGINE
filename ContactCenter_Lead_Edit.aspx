<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ContactCenter_Lead_Edit.aspx.cs" Inherits="ContactCenter_Lead_Edit" %>
            ...
            <asp:UpdatePanel ID="upnl1" runat="server">
                <ContentTemplate>
                    <div class="row-fluid">
                                            ...
                                            <div class="span12">
                                                <div>
                                                    <div class="row-fluid">
                                                        ...
                                                        <ContactInfoPanel:ContactInfoPanel runat="server" ID="ContactInfoPanel1">
                                                        ...
                                                        <div class="span12">
                                                            <div class="widget-box">
                                                                <div class="widget-header">
                                                                    ...
                                                                    &nbsp;&nbsp;
                                                                    <%--<button id="btnEditCon" runat="server" data-rel="tooltip" data-placement="left"
                                                                        visible="true" title="Edit  Contact" class="btn btn-app btn-primary btn-mini radius-4"
                                                                        onserverclick="btnEditCon_Click">
                                                                        <i class="icon-edit"></i>
                                                                    </button>
                                                                    <button id="btnRefreshCon" runat="server" data-rel="tooltip" data-placement="left"
                                                                        visible="true" title="Refresh  Lead" class="btn btn-app btn-primary btn-mini radius-4"
                                                                        ...
                                                                        <table class="table table-striped table-bordered table-advance table-hover">
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ControlToValidate="ddlContactsourceadd"
                                                                                ...
                                                                                <td width="20%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFielferedValidator4" ControlToValidate="ddlContactType"
                                                                                ...
                                                                                <td width="20%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="ddlcustomertype"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatosdwr12" ControlToValidate="ddlTitle"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    ...
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValere4idator2" runat="server"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" ControlToValidate="txtHandPhone1"
                                                                                    ...
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidfgdator5" runat="server"
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:TextBox ID="txtlandline" runat="server" Width="205px" placeholder="Landline No."
                                                                                        Enabled="false" ValidationGroup="Grplead2" MaxLength="18" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"></asp:TextBox>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="txtlandline"
                                                                                        Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="true" ErrorMessage="Please Enter Only Numbers"
                                                                                        ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                                                    ...
                                                                    <div class="widget-main">
                                                                        <table class="table table-striped table-bordered table-advance table-hover">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddlleadtypeadd" runat="server" Enabled="false" CssClass="chzn-select"
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddlleadsourceadd" runat="server" CssClass="chzn-select" ValidationGroup="Grplead"
                                                                                        data-trigger="hover" data-placement="top" data-content="Select lead Source" Enabled="false">
                                                                                    </asp:DropDownList>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddlacademicyear" runat="server" Width="215px" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" data-trigger="hover" data-placement="top" data-content="Select Expected Joining Academic Year"
                                                                                        Enabled="false">
                                                                                    </asp:DropDownList>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="ddlacademicyear"
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:TextBox ID="txtExpjoindate" placeholder="Expected Joining Date" runat="server"
                                                                                        Width="205px" ValidationGroup="Grplead" Enabled="false"></asp:TextBox>
                                                                                    ...
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server"
                                                                                        ControlToValidate="txtExpjoindate" ValidationGroup="Grplead" Text="#" SetFocusOnError="True"
                                                                            ...
                                                                            <tr runat="server" id="trTest" visible="false">
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddldiscipline" Width="215px" runat="server" CssClass="chzn-select"
                                                                                        AutoPostBack="true" OnSelectedIndexChanged="ddldiscipline_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                                <td width="10%">
                                                                                    Field Interested
                                                                    ...
                                                                    <div class="widget-main">
                                                                        <table class="table table-striped table-bordered table-advance table-hover" id="tblorgassign"
                                                                            ...
                                                                            <tr id="trSourcecompany" runat="server">
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddlsourcecompanyadd" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" OnSelectedIndexChanged="ddlcompanyadd_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                                            ...
                                                                            <tr id="tblrow1" runat="server">
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddlSourcedivisionadd" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" OnSelectedIndexChanged="ddlSourcedivisionadd_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddlSourcezoneadd" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" OnSelectedIndexChanged="ddlSourcezoneadd_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                                            ...
                                                                            <tr id="trtargetcompany" runat="server">
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddltargetcompanyadd" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" OnSelectedIndexChanged="ddltargetcompanyadd_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddltargetdivisionadd" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" OnSelectedIndexChanged="ddltargetdivisionadd_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:DropDownList ID="ddltargetzoneadd" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                                        ValidationGroup="Grplead" OnSelectedIndexChanged="ddltargetzoneadd_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                ...
                                                <td width="20%"><asp:DropDownList ID="ddlrole" runat ="server" AutoPostBack ="true" Width="86%" ValidationGroup="Grplead" CssClass="chzn-select"></asp:DropDownList></td>--%>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <asp:TextBox ID="txtassignedto" runat="server" Width="86%" MaxLength="6" ValidationGroup="Grplead"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <asp:DropDownList ID="ddldevice" runat="server" TabIndex="21" CssClass="chzn-select"
                                                                    AutoPostBack="true" ValidationGroup="Grplead" Width="215px">
                                                                </asp:DropDownList>
                                                            ...
                                                            <td width="20%">
                                                                <asp:DropDownList ID="ddlownedby" runat="server" CssClass="chzn-select" AutoPostBack="true"
                                                                    ValidationGroup="Grplead" Width="215px">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtotherbrand" runat="server" placeholder="Other Brand" Enabled="false"
                                                                    ValidationGroup="Grplead" CssClass="input-large uppercase" Width="205px"></asp:TextBox>
                                                    ...
                                                    <table class="table table-striped table-bordered table-advance table-hover" runat="server"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="date_picker"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <%--<div class="row-fluid input-append date">--%>
                                                                <asp:TextBox ID="date_picker1" TabIndex="15" Placeholder="Installation Date" runat="server"
                                                            ...
                                                            <td width="20%">
                                                                <asp:DropDownList ID="ddlinstallationstatus" runat="server" CssClass="chzn-select"
                                                                    ValidationGroup="Grplead" Width="215px">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <%--<div class="row-fluid input-append date">--%>
                                                                <asp:TextBox ID="date_picker2" TabIndex="15" Placeholder="Rescheduled Date" runat="server"
                                                                    Width="205px" ValidationGroup="Grplead"></asp:TextBox>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtengineername" runat="server" placeholder="Engineer Name" ValidationGroup="Grplead"
                                                                    CssClass="input-large uppercase" Width="205px"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtengineercontactnumber" runat="server" placeholder="Contact number of Engineer"
                                                                    ValidationGroup="Grplead" CssClass="input-large uppercase" Width="205px"></asp:TextBox>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtengineeremailid" runat="server" placeholder="Email id of Engineer "
                                                                    ValidationGroup="Grplead" CssClass="input-large uppercase" Width="205px"></asp:TextBox>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtengineercompany" runat="server" placeholder="Company Engineer belongs to"
                                                                    ValidationGroup="Grplead" CssClass="input-large uppercase" Width="205px"></asp:TextBox>
                                                    ...
                                                    <div class="well" style="text-align: center; background-color: #F0F0F0">
                                                        <button class="btn btn-app btn-success btn-mini radius-4" id="btneditsubmit" runat="server"
                                                            validationgroup="Grplead" onserverclick="btneditsubmit_ServerClick">
                                                            Save</button>
                                                    ...
                                                    <asp:ValidationSummary ID="ValidationSummary3" runat="server" ShowSummary="false"
                                                        ShowMessageBox="true" ValidationGroup="Grplead" />
                                                    <div class="row-fluid" runat="server" visible="false">
                                                        <div class="span12">
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="20%">
                                                                            <button type="button" class="btn btn-small btn-primary" id="btnaddcontact" runat="server"
                                                                                onserverclick="btnaddcontact_ServerClick">
                                                                                <i class="icon-pencil"></i>Add Secondary Contact</button>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                            </table>
                                                            <asp:DataList ID="dlseccontact" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label7" Text='<%#DataBinder.Eval(Container.DataItem, "Emailid")%>'
                                                                            runat="server"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label5" Text='<%#DataBinder.Eval(Container.DataItem, "Institution_Desc")%>'
                                                                            runat="server"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label3" Text='<%#DataBinder.Eval(Container.DataItem, "Board_Desc")%>'
                                                                            runat="server"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label4" Text='<%#DataBinder.Eval(Container.DataItem, "Standard_desc")%>'
                                                                            runat="server"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label6" Text='<%#DataBinder.Eval(Container.DataItem, "Year_desc")%>'
                                                                            runat="server"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:LinkButton ID="lnkedit" runat="server" CommandName="Edit" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Con_id")%>'
                        ...
                        <div class="row-fluid">
                            <HistoryPanel:HistoryPanel runat="server" ID="HistoryPanel1">
                                                    ...
                                                    <table class="table table-striped table-bordered table-advance table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1002" ControlToValidate="ddlseccontacttype2"
                                                                    Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="True" ErrorMessage="Select Contact Type"
                                                                    InitialValue="Select" />
                                                            </td>
                                                            <td width="10%">
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlsectitle2"
                                                                    Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="True" ErrorMessage="Select Title"
                                                                    InitialValue="Select" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                --%>
                                                                <asp:RequiredFieldValidator ID="RequiredFiel45dValidator5" ControlToValidate="txtsecfname2"
                                                                    Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="True" ErrorMessage="Enter Name" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                ...
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator32" ControlToValidate="txtsechandphone12"
                                                                    Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="true" ErrorMessage="Please Enter Only Numbers"
                                                                    ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtsechandphone22" runat="server" Width="79%" placeholder="Handphone 2"
                                                                    ValidationGroup="Grplead2" MaxLength="18" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator34" ControlToValidate="txtsechandphone22"
                                                                    Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="true" ErrorMessage="Please Enter Only Numbers"
                                                                    ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator37" runat="server" ControlToValidate="txtseclandline2" ErrorMessage="Handphone length must be between 7 to 18 characters"  ValidationGroup ="Grplead2" Text ="#" SetFocusOnError ="true"  ValidationExpression="^[0-9]{7,18}$" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:DropDownList ID="ddlseccity2" runat="server" AutoPostBack="true" CssClass="chzn-select"
                                                                        ValidationGroup="Grplead2">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtsecpincode2" runat="server" placeholder="Postal Code" MaxLength="10"
                                                                    ...
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator38" ControlToValidate="txtsecpincode2"
                                                                        Text="#" runat="server" ValidationGroup="Grplead2" SetFocusOnError="true" ErrorMessage="Please Enter Only Numbers"
                                                                        ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator39" ControlToValidate="txtsecpincode2"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%">
                                                                <asp:TextBox ID="txtnameofinstitution2" runat="server" placeholder="Institution name"
                                                                    MaxLength="100" Width="79%" ValidationGroup="Grplead2" CssClass="popovers " data-trigger="hover"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="20%" colspan="5">
                                                                <asp:TextBox ID="txtadditiondesc2" runat="server" placeholder="Additional Information"
                                                                    Width="94%" MaxLength="100" CssClass="popovers " data-trigger="hover" data-placement="top"
