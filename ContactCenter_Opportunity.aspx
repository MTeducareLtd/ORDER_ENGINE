<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ContactCenter_Opportunity.aspx.cs" Inherits="ContactCenter_Opportunity" ViewStateMode="Inherit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        ...
        <div id="nav-search">
            ...
            <%--<button type="button" class="btn  btn-primary btn-small radius-4  btn-danger" id="btnaddOpp"
                runat="server" onserverclick="btnaddOpp_ServerClick">Add Opportunity</button>--%>
            <button data-toggle="dropdown" class="btn btn-danger btn-small dropdown-toggle" runat="server" visible="false" id="btnAction">
            ...
            <ul class="dropdown-menu dropdown-yellow pull-right dropdown-caret dropdown-close">
                ...
                <li><a href="#" id="btnaddOpp" runat="server" onserverclick="btnaddOpp_ServerClick" visible="false">
                                        ...
                                        <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlacadyearsearch" Width="215px" runat="server" OnSelectedIndexChanged="ddlacadyearsearch_SelectedIndexChanged"
                                                            AutoPostBack="true" data-placeholder="Select Acad Year" CssClass="chzn-select" ValidationGroup="Grplead2">
                                                        </asp:DropDownList>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlproductcategory" Width="215px" runat="server" AutoPostBack="true" data-placeholder="Select Product Category"
                                                            CssClass="chzn-select">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="10%">
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlstreamsearch" Width="215px" runat="server" AutoPostBack="true" data-placeholder="Select Stream"
                                                            CssClass="chzn-select">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <tr>
                                            ...
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                ...
                                                <tr id="tr15" runat="server" visible="false">
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlstatus" runat="server" Width="215px" AutoPostBack="true" data-placeholder="Select Status"
                                                            CssClass="chzn-select">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="widget-box">
                                            <div class="widget-header widget-hea1der-small header-color-dark">
		                                        <h4 class="smaller"><i class ="icon-briefcase"></i> Opportunity Search Results</h4>
                                                <div class="widget-toolbar">
					                                <div class="btn-group">
                                                        <a  class="btn btn-danger btn-mini radius-4" href="Opportunity_Add.aspx" runat="server" visible="false">Add Opportunity <i class="icon-plus-sign"></i>
                                                        </a>
                                                    </div>
				                                </div>
	                                      </div>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand"
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Opportunity_Code","ContactCenter_Opportunity_Display.aspx?&Opportunity_Code={0}") %>'
                                                                ...
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Opportunity_Code","ContactCenter_Opportunity_Edit.aspx?&Opportunity_Code={0}") %>'
                                                                ...
                                                                <asp:LinkButton ID="lnkedit" runat="server" CommandName="Edit" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Opportunity_Code")%>'
                                                                    Visible="false"></asp:LinkButton>
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Opportunity_Code","Opportunity_Followup.aspx?&Opportunity_Code={0}&Flag=100") %>'
                                                                ...
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Opportunity_Code","Opportunity_Followup.aspx?&Opportunity_Code={0}&Flag=100") %>'
                                                                    id="lnkfollowupenroll" runat="server" target="_blank" class="btn btn-minier btn-primary icon-comments tooltip-info"
                                                                    data-rel="tooltip" data-placement="top" title="Follow-up"></a>
                                                               <%-- <asp:LinkButton ID="lnkfollowupenroll" runat="server" class="btn btn-minier btn-primary icon-comments tooltip-info"
                                                                ...
                                                                <asp:Label ID="Label12" Text='<%#DataBinder.Eval(Container.DataItem, "Opp_Contact_Target_Company")%>'
                                                                    runat="server" Visible="false"></asp:Label>
                                                                <a href='<%#DataBinder.Eval(Container.DataItem,"Opportunity_Code","ContactCenter_Manage_Order.aspx?&Opportunity_Code={0}") %>'
