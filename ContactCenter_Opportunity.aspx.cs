...
public partial class ContactCenter_Opportunity : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.Cookies["MyCookiesLoginInfo"] != null)
            {
                ...
                if (UserCompany == "MPUC")
                {
                    tdadmissionno.Visible = true;
                    tdadmissionno1.Visible = true;
                }
                else
                {
    ...
    protected void btnsearch_ServerClick(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet ds = UserController.Get_EComSalesOpportunity_Search_Results_New_New_New(Company, Division, Zone, Center, customer_type, institution_type, board_id, standard, name, mobile,
    ...
    protected void Repeater1_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Display")
        {
            ...
            Response.Redirect("ContactCenter_Opportunity_Display.aspx?&Opportunity_Code=" + Opportunity_Code);
        }
        else if (e.CommandName == "Edit")
        {
            //System.Threading.Thread.Sleep(100)
            string Opportunity_Code = e.CommandArgument.ToString();
            Response.Redirect("ContactCenter_Opportunity_Edit.aspx?&Opportunity_Code=" + Opportunity_Code);
        }
        else if (e.CommandName == "Followup")
        {
            //System.Threading.Thread.Sleep(100)
            string Opportunity_Code = e.CommandArgument.ToString();
            Response.Redirect("Opportunity_Followup.aspx?&Opportunity_Code=" + Opportunity_Code + "&Flag=100");
        }
    ...
    protected void Repeater1_ItemDataBound(object sender, System.Web.UI.WebControls.RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            if (Isactive == "1")
            {
                ...
                ((HtmlAnchor)e.Item.FindControl("lnkfollowupenroll")).Visible = false;
            ...
            else
            {
                ...
                if (CheckEdit == "1")
                {
                    ...
                    if (company == "MT")
                    {
                        ...
                        ((HtmlAnchor)e.Item.FindControl("lnkfollowupenroll")).Visible = true;
