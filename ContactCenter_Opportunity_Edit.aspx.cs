...
public partial class ContactCenter_Opportunity_Edit : System.Web.UI.Page
{
            ...
            if (Request["Opportunity_Code"] != null)
            {
                ...
                if ((((dr) != null)))
                {
                    if (dr.Read())
                    {
                        ...
                        //Currentyear()
                        //ddlacademicyear.SelectedValue = dr("Current_Year_Id").ToString
                        StudentType();
    ...
    protected void btnEditSubmit_ServerClick(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            opp_product = txtproductInterested.Text.Trim();
            opp_product_id = "1000";
