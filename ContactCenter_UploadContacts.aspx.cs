...
public partial class ContactCenter_UploadContacts : System.Web.UI.Page
{
    ...
    {        
        ...
        string filepath = Server.MapPath("~/Images/ContactCenter_template.csv");
    ...
    protected void btnSaveContacts_Click(object sender, EventArgs e)
    {
        Msg_Error.Visible = false;
        Msg_Success.Visible = false;
        string Row_num = "", XMLData = "<Contacts>"; //ContactSource = "", Contacttitle = "", ContactFirstName = "", ContactMidName = "", ContactLastName = "", Gender = "", EmailId = "", Handphone1 = "", Country = "";
        foreach (DataListItem dtlItem in dlviewExcelFormat.Items)
        {
            ...
            else
            {
                ...
                //Check the handphone1 length
                if ((lbErrorSaveMessage.Text == "") && ((lblHandphone1.Text.Length < 10) || (lblHandphone1.Text.Length > 18)))
                {
                    lbErrorSaveMessage.CssClass = "red";
                    lbErrorSaveMessage.Text = "Handphone1 length must be between 10 to 18 characters";
                }

                if ((lbErrorSaveMessage.Text == "") && (lblHandphone2.Text != ""))
                {
                ...
                //Check LandLine Number Valdation
                if ((lbErrorSaveMessage.Text == "") && (lblLandLine.Text != ""))
                {
                ...
                if (lbErrorSaveMessage.Text == "")
                {
                    ...
                    XMLData = XMLData + "<Contact><Row>" + lblRowNum.Text.Trim() + "</Row><Source>" + lblContact_Source.Text.Trim() + "</Source><Title>" + lblCon_Title.Text.Trim() + "</Title><FName>" + lblCon_FirstName.Text.Trim() + "</FName><MName>"
                            ...
                            + lblHandphone1.Text.Trim() + "</Handphone1><Handphone2>" + lblHandphone2.Text.Trim() + "</Handphone2><LandLine>" + lblLandLine.Text.Trim() + "</LandLine><Country>" + lblCountry.Text.Trim() + "</Country></Contact>";                   
        ...
        if (Row_num != "")  //Call sp
        {
            try
            {
                ...
                //ds = ProductController.Insert_Contacts_ExcelUpload(Row_num, ContactSource, Contacttitle, ContactFirstName, ContactMidName, ContactLastName, Gender, EmailId, Handphone1, Country, Created_By, lblfileName1.Text, lbltotalcount.Text, "1");
                ds = ProductController.Insert_Contacts_ExcelUpload(XMLData, Created_By, lblfileName1.Text, lbltotalcount.Text, "1");
                if (ds != null)
                {
    ...
    protected void btnExportErrorContacts_Click(object sender, EventArgs e)
    {
        ...
        DataRow dr;
        tb.Columns.Add("Con_Title", typeof(string));
        tb.Columns.Add("Con_FirstName", typeof(string));
        tb.Columns.Add("Con_MidName", typeof(string));
        tb.Columns.Add("ConLastName", typeof(string));
        ...
        foreach (DataListItem dtlItem in dlviewExcelFormat.Items)
        {
            ...
            if (lbErrorSaveMessage.CssClass == "red")
            {
                ...
                dr = tb.NewRow();
                dr["Con_Title"] = lblCon_Title.Text.Trim();
                dr["Con_FirstName"] = lblCon_FirstName.Text.Trim();
                dr["Con_MidName"] = lblCon_MidName.Text.Trim();
                dr["ConLastName"] = lblConLastName.Text.Trim();
