<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Contact_Edit.aspx.cs" Inherits="Contact_Edit" %>
                                            ...
                                            <div class="span12">
                                                <div class="widget-box">
                                                    <div class="widget-header widget-header-small header-color-dark">
                                                        ...
                                                        <asp:Label ID="lblAcadInfoRecordNo" runat="server" Visible="false" Style="padding-left:14px"></asp:Label>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" runat="server"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" ControlToValidate="ddlnameofinstitution"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlexamname" runat="server" Width="215px" CssClass="chzn-select"
                                                                            data-trigger="hover" data-placement="top" data-content="Select Exam" AutoPostBack="true" OnSelectedIndexChanged="ddlexamname_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:TextBox ID="txtFinalMarksObtained" runat="server" placeholder="Final Marks Obtained"
                                                                            Width="205px" MaxLength="100" data-trigger="hover" data-placement="top" data-content="Enter Final Obtained Marks" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;">></asp:TextBox>
                                                                    </td>
                                                                    <td width="10%">
                                                                        Final Marks Total
                                                                    </td>
                                                                    <td width="20%">
                                                                        <asp:TextBox ID="txtFinalMarksTotal" runat="server" placeholder="Final Marks Total"
                                                                            Width="205px" data-trigger="hover" data-placement="top" data-content="Enter Final Obtained Total" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;">></asp:TextBox>
                                                                    </td>
                                                                ...
                                                                <asp:DataList ID="dlAcadInfo" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Label ID="lblInstitutionType" Text='<%#DataBinder.Eval(Container.DataItem, "Institution_Type_Desc")%>'
                                                                         ...
                                                                         <asp:Label ID="lblnameofinstitutionid" Text='<%#DataBinder.Eval(Container.DataItem, "School_College_Id")%>'
                                                                            runat="server" Visible="false"></asp:Label>
                                                                        <asp:Label ID="lblexamnameid" Text='<%#DataBinder.Eval(Container.DataItem, "Exam_Id")%>'
                                                                            runat="server" Visible="false"></asp:Label>
                                                                        <asp:Label ID="lblexamstatusid" Text='<%#DataBinder.Eval(Container.DataItem, "Exam_Status_Id")%>'
                                                                            runat="server" Visible="false"></asp:Label>
                                                                        <asp:Label ID="lblexamrank" Text='<%#DataBinder.Eval(Container.DataItem, "Exam_Rank")%>'
                                                                            runat="server" Visible="false"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <div class="widget-body">
                                                        <div class="widget-main">
                                                            ...
                                                            <div class="row-fluid">
                                                                ...
                                                                <asp:Label ID="lblSecConRecord" CssClass="red" Visible="False" runat="server" Font-Bold="True" Style="padding-left:14px"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
