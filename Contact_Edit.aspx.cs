...
public partial class Contact_Edit : System.Web.UI.Page
{
    ...
    protected void btnSaveAcadInfo_ServerClick(object sender, EventArgs e)
    {
        try
        {
            ...
            string UserID = cookie.Values["UserID"];
            string examstatus = "";
            if (ddlexamstatus.SelectedValue=="")
            {
                examstatus = "Select";
            }
            else
            { 
                examstatus=ddlexamstatus.SelectedItem.Text;
            }

            DataSet ds = ProductController.Insert_Update_Contact_AcadInfo(ddlinstitutiontype.SelectedValue, ddlinstitutiontype.SelectedItem.ToString(), ddlnameofinstitution.SelectedItem.Text, ddlboard.SelectedValue, ddlboard.SelectedItem.ToString(), ddlcurrentstudying.SelectedValue, ddlcurrentstudying.SelectedItem.ToString(),
                            ddlsection.SelectedValue, ddlsection.SelectedItem.ToString(), ddlyearofpassing.SelectedValue, ddlyearofpassing.SelectedItem.ToString(), txtadditiondesc.Text.Trim(), ddlexamname.SelectedItem.Text, txtFinalMarksObtained.Text.Trim(), txtFinalMarksTotal.Text.Trim(), txtGrade.Text.Trim(), txtPercentage.Text.Trim(), lblPKey_Con_Id.Text, UserID,
                            "", "2", ddlexamname.SelectedValue, ddlexamstatus.SelectedValue, examstatus, txtexamrank.Text.Trim(), ddlnameofinstitution.SelectedValue, ddlnameofinstitution.SelectedItem.Text);
            if (ds.Tables[0].Rows[0]["Result"].ToString() == "1")
            {
    ...
    protected void btnUpdateAcadInfo_ServerClick(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet ds = ProductController.Insert_Update_Contact_AcadInfo(ddlinstitutiontype.SelectedValue, ddlinstitutiontype.SelectedItem.ToString(), ddlnameofinstitution.SelectedItem.Text, ddlboard.SelectedValue, ddlboard.SelectedItem.ToString(), ddlcurrentstudying.SelectedValue, ddlcurrentstudying.SelectedItem.ToString(),
                            ...
                            ddlexamname.SelectedValue, ddlexamstatus.SelectedValue, ddlexamstatus.SelectedItem.Text, txtexamrank.Text.Trim(), ddlnameofinstitution.SelectedValue, ddlnameofinstitution.SelectedItem.Text);
            if (ds.Tables[0].Rows[0]["Result"].ToString() == "1")
            {
                dlAcadInfo.DataSource = ds.Tables[1];
                dlAcadInfo.DataBind();
        ...
        if (e.CommandName == "Edit")
        {
            foreach (DataListItem item in dlAcadInfo.Items)
            {
                ...
                if (lblRowNumber.Text == e.CommandArgument.ToString())
                {
                    ...
                    ddlexamname.SelectedItem.Text = lblExamName.Text;
                    ...
                    txtexamrank.Text = lblexamrank.Text;
                    tblAddAcadinfo.Visible = true;
