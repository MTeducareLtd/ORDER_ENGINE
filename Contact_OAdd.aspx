<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Contact_OAdd.aspx.cs" Inherits="Contact_OAdd" %>
                                        ...
                                        <div class="table-responsive">
                                                    ...
                                                    <div class="widget-main">
                                                        <table class="table table-striped table-bordered table-advance table-hover">
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtproductcategory" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                                                </td>
                                                                <td width="10%">
                                                                    Sales Stage
                                                                </td>
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtsalesstage" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr id="tr67" runat="server" visible="false">
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtopporstatus" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="10%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtjoindate" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                                                </td>
                                                                <td width="10%">
                                                                    Expected Closure Date
                                                                </td>
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtexpectedate" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                                                </td>
                                                                <td width="10%">
                                                                    Probability Percent
                                                                </td>
                                                                <td width="20%">
                                                                    <asp:TextBox ID="txtprobpercent" runat="server" Enabled="false" Width="95%"></asp:TextBox>
                                            ...
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%">
                                                            <asp:CheckBox ID="chkaddcopy" runat="server" AutoPostBack="true"
                                                                OnCheckedChanged="chkaddcopy_CheckedChanged" /><span class="lbl"> Same As Primary Contact</span>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlseccontacttype" runat="server" data-placeholder="Select Contact Type" CssClass="chzn-select" ValidationGroup="Grplead2"
                                            ...
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlinstitutiontype2" runat="server" OnSelectedIndexChanged="ddlinstitutiontype2_SelectedIndexChanged"
                                                            AutoPostBack="true" data-placeholder="Select Type" CssClass="chzn-select" ValidationGroup="Grplead2" 
                                                            data-trigger="hover" data-placement="top" data-content="Select Institution Type">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="10%">
                                                        Institution Name
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlboard2" runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="Grplead2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlcurrentstudying2" runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="Grplead2">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="10%">
                                                        Division / Section
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlsection2" runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="Grplead2"
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlyearofpassing2" runat="server" data-placeholder="Select" CssClass="chzn-select" ValidationGroup="Grplead2"
                                            ...
                                            <div class="well" style="text-align: center; background-color: #F0F0F0">
                                                    ...
                                                    <button class="btn btn-app btn-success btn-mini radius-4" id="btnSubmitSeccon" runat="server" validationgroup="Grplead2"
                                                        onserverclick="btnSubmitSeccon_ServerClick">
                                                        Save
                                                    </button>
