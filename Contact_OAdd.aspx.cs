...
public partial class Contact_OAdd : System.Web.UI.Page
{
        ...
        if (Request["Opportunity_Code"] != null)
        {
            ...
            if ((((dr) != null)))
            {
                if (dr.Read())
                {
                    ...
                    txtsalesstage.Text = dr["SalesStagedesc"].ToString();
                    ...
                    txtjoindate.Text = dr["Opp_Join_Date_Con"].ToString();
                    txtexpectedate.Text = dr["Opp_Expected_Close_Date_Con"].ToString();
                    txtprobpercent.Text = dr["Opp_Probability_Percent"].ToString();
                    lblcompany.Text = dr["Opp_Contact_Company"].ToString();
                    lbldivision.Text = dr["Opp_Contact_Division"].ToString();
                    lblcenter.Text = dr["Opp_Contact_Center"].ToString();
                    lblstream.Text = dr["Oppor_Product_Id"].ToString();
                }
            }
        }
    }
    ...
    protected void btnSubmitSeccon_ServerClick(object sender, System.EventArgs e)
    {
        ...
        Response.Redirect("Opportunity_Edit.aspx?&Opportunity_Code=" + Oppur_Id);
    }
