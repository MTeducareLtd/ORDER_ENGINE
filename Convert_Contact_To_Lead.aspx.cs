...
public partial class Convert_Contact_To_Lead : System.Web.UI.Page
{
    ...
    private void BindSecContactDetails(string Conid)
    {
        ...
        //editContact.HRef = "Contact_Edit.aspx?&Con_id=" + lblConId.Text;
    ...
    protected void btnSaveConvertContactToLead_Click(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows[0]["Result"].ToString() == "1")//The Record is Save successfully
        {
            ...
            ConvertToOpp.HRef = "Convert_Lead_To_Opportunity.aspx?&Lead_Code=" + lblPKeyContactId.Text;

            //Response.Redirect("Convert_Lead_To_Opportunity.aspx?&Lead_Code=" + lblPKeyContactId.Text);
    ...
    protected void btn_ConvertToOppYes_Click(object sender, EventArgs e)
    {
        ...
        //string url = "Convert_Lead_To_Opportunity.aspx?&Lead_Code=" + lblPKeyContactId.Text;
    ...
    {
        Response.Redirect("Convert_Contact_To_Lead.aspx?&Con_id=" + lblConId.Text);       
    }
