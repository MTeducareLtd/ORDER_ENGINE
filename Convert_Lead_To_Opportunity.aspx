<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Convert_Lead_To_Opportunity.aspx.cs" Inherits="Convert_Lead_To_Opportunity" %>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" id="tblconvertOpp"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="10%" id="tdapplicationno" runat="server">
                                                                        App. Form No.
                                                                        <asp:Label ID="lblAppFormNoVal" runat="server" Text=" *" Visible="false" ForeColor="#FF3300"></asp:Label>
                                                                    </td>
