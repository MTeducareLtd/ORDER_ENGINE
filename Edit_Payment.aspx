<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Edit_Payment.aspx.cs" Inherits="Edit_Payment" %>
        ...
        <div id="breadcrumbs" class="position-relative" style="height: 53px">
            ...
            <div id="nav-search">
                <span id="listudentstatus" runat="server">
                    <span id="badgeError" runat="server" class="badge badge-important" visible ="true">Student Status : Pending</span>
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li><a id="btnregistrationno" runat="server" visible="false" href="Series.aspx" target="_blank"
                        onserverclick="btnregistrationno_ServerClick">Manage Statutory Info.</a></li>
        ...
        <div class="page-content">
            ...
            <asp:UpdatePanel ID="Upnlviewledger" runat="server">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddllcompany" Enabled="false" runat="server" Width="90%">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="10%">
                                                        Division
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddlldivision" Enabled="false" runat="server" Width="90%">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddllcenter" Enabled="false" runat="server" Width="90%">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="10%">
                                                        Academic Year
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddllacadyear" Enabled="false" runat="server" Width="90%">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        <asp:DropDownList ID="ddllstream" Enabled="false" runat="server" Width="90%">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="10%">
                                                        Pay Plan
                                ...
                                <div class="row-fluid" id="div5" runat="server">
                                    <div class="span3">
                                        ...
                                        <div class="widget-box">
                                            ...
                                            <div class="widget-body" style="height: 700px; overflow: Auto; overflow-y:hidden; overflow-x:hidden;">
                                    ...
                                    <div class="span9">
                                        ...
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h5>
                                                    <i class="fa fa-anchor"></i>Payment
                                                </h5>
                                                <div class="widget-toolbar">
                                                    <div class="btn-group">
                                                    </div>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-app btn-success btn-mini radius-4" id="btnaddpayment"
                                                            runat="server" onserverclick="btnaddpayment_ServerClick" visible ="false" >
                                                            Add</button>
                                                    </div>
                                                    <div class="btn-group" id="divevents" runat="server">
                                                        <button type="button" class="btn btn-app btn-primary btn-mini radius-4" id="btnproceedprint"
                                                            runat="server" onserverclick="btnproceedprint_ServerClick" visible="false">
                                                            Print</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="widget-body" style="height: 700px; overflow: Auto">
                                                <div class="widget-main">
                                                    <asp:DataList ID="dlpaymentreceipt" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" OnItemDataBound ="dlpaymentreceipt_ItemDataBound"
                                                         OnItemCommand ="dlpaymentreceipt_ItemCommand" Height="20px">
                                                        <HeaderTemplate>
                                                            <b>Receipt Date</b></th>
                                                            <th>
                                                                Payee
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <td>
                                                                    <asp:LinkButton ID="lnkedit" runat="server" class="btn btn-minier btn-primary icon-edit tooltip-info" CommandName="Edit" data-rel="tooltip" data-placement="top" title="Edit"
                                                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Chequeidno")%>'></asp:LinkButton>

                                                                    <asp:LinkButton ID="lnkblock" runat="server" CommandName="Remove" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Chequeidno")%>'
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpaymode" runat="server" Width="84%" AutoPostBack="true" OnSelectedIndexChanged ="ddlpaymode_SelectedIndexChanged"
                                                                            ValidationGroup="Val6">
                                                                        </asp:DropDownList>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:TextBox ID="txtmicrcode" runat="server" AutoPostBack="true" Width="84%" OnTextChanged ="txtmicrcode_TextChanged" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"></asp:TextBox>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:TextBox ID="txtchqno" runat="server" Width="84%" MaxLength="10" onKeypress="if (event.keyCode &lt; 44 || event.keyCode &gt; 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"></asp:TextBox>
                                                                        ...
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server"
                                                                            ...
                                                                            SetFocusOnError="true" ControlToValidate="txtchqno" ValidationExpression="^[0-9]{6,10}$" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="10%">
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpayee" runat="server" Width="84%" AutoPostBack="true" ValidationGroup="Val6" OnSelectedIndexChanged ="ddlpayee_SelectedIndexChanged">
                                                                        </asp:DropDownList>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        ...
                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="DD no. should be between 6-10"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpayeedd" runat="server" Width="84%" AutoPostBack="true" OnSelectedIndexChanged ="ddlpayeedd_SelectedIndexChanged"
                                                                            ValidationGroup="Val6">
                                                                        </asp:DropDownList>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpayeecash" runat="server" Width="84%" AutoPostBack="true" OnSelectedIndexChanged ="ddlpayeecash_SelectedIndexChanged"
                                                                            ValidationGroup="Val6">
                                                                        </asp:DropDownList>
                                                            ...
                                                            <button type="button" class="btn btn-app btn-primary btn-mini radius-4" id="btnclosepayment" runat="server" onserverclick ="btnclosepayment_ServerClick">
                                                                Close</button>
                                                            <button type="button" class="btn btn-app btn-success btn-mini radius-4" runat="server" id="btnsavepayment" validationgroup="Val6" onserverclick ="btnsavepayment_ServerClick" >
                                                                Save
                                                            </button>
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:TextBox ID="txtmicrcodeedit" runat="server" AutoPostBack="true" Width="84%" OnTextChanged ="txtmicrcodeedit_TextChanged"
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpayeeedit" Enabled="false" runat="server" Width="84%" AutoPostBack="true"
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpayeeddedit" Enabled="false" runat="server" Width="84%"
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover" width="100%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%">
                                                                        <asp:DropDownList ID="ddlpayeecashedit" Enabled="false" runat="server" Width="84%"
                                                                            AutoPostBack="true" ValidationGroup="Val6">
                                                                        </asp:DropDownList>
                                                            ...
                                                            <asp:DataList ID="dlallocationedit" runat="server" Enabled="false" Width="100%" CssClass="table table-striped table-bordered table-hover">
                                                                <HeaderTemplate>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td align="right">
                                                                        ...
                                                                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ErrorMessage="Enter only Numeric Value"  ValidationGroup ="Val6" Text ="#" SetFocusOnError ="true" ControlToValidate="txtcurrentallocation" ValidationExpression="^[0-9]{1,10}$" />
                                                                        --%><asp:Label ID="lblproductheadercode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"pricing_procedure_code")%>'
                                                                            Visible="false"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:DataList>
                                                            ...
                                                            <button type="button" class="btn default" id="btnclosepaymentedit" runat="server" onserverclick ="btnclosepaymentedit_ServerClick">
                                                                Close</button>
                                                            <button type="button" class="btn blue" runat="server" id="btnsavepaymentedit" validationgroup="Val6" onserverclick ="btnsavepaymentedit_ServerClick">
                                                                Save
                                                            </button>
                ...
                <Triggers>
                    ...
                    <asp:PostBackTrigger ControlID="btnsavepaymentedit" />
                </Triggers>
            </asp:UpdatePanel>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn default" id="btnclosemessage" runat="server" onserverclick ="btnclosemessage_ServerClick">
                                Close</button>
                        </div>
                    </div>
                </ContentTemplate>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="scroller" style="height: 400px" data-always-visible="1" data-rail-visible1="1">
                        <div class="row-fluid">
                            <div class="col-md-12" style="overflow: 200px">
                                <div class="table-responsive">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn default" id="btnSwapClose" runat="server">
                        Close</button>
                    <button type="button" class="btn blue" runat="server" id="btnSaveswap" validationgroup="Val15">
                        Save
                    </button>
