...
public partial class Lead : System.Web.UI.Page
{
    ...
    private void BindCompany()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ddlsourcedivision.DataSource = ds.Tables[1];
            ddlsourcedivision.DataTextField = "division_name";
            ddlsourcedivision.DataValueField = "division_code";
            ddlsourcedivision.DataBind();
            ddlsourcedivision.Items.Insert(0, "All");
            ddlsourcedivision.SelectedIndex = 0;
            if (ddlsourcedivision.Items.Count > 1)
            {
                ddlsourcedivision.SelectedIndex = 1;
                //ddlsourcezone.DataSource = ds.Tables[2];
                //ddlsourcezone.DataTextField = "Zone_Name";
                //ddlsourcezone.DataValueField = "Zone_Code";
                //ddlsourcezone.DataBind();
                //ddlsourcezone.Items.Insert(0, "All");
                //ddlsourcezone.SelectedIndex = 0;
                if (ddlsourcedivision.Items.Count > 1)
                {
                    //ddlsourcezone.SelectedIndex = 1;
                    ddlsourcecenter.DataSource = ds.Tables[3];
                    ddlsourcecenter.DataTextField = "center_name";
                    ddlsourcecenter.DataValueField = "center_code";
                    ddlsourcecenter.DataBind();
                    ddlsourcecenter.Items.Insert(0, "All");
                    ddlsourcecenter.SelectedIndex = 0;
                    if (ddlsourcecenter.Items.Count > 1)
                    {
                        ddlsourcecenter.SelectedIndex = 1;
                    }
                }
                else
                {
    ...
    private void BindCenter()
    {
        ...
        string UserID = cookie.Values["UserID"];
        string UserName = cookie.Values["UserName"];
        DataSet ds = ProductController.GetUser_Company_Division_Zone_Center(5, UserID, ddlsourcedivision.SelectedValue, "", ddlcompany.SelectedValue);
    ...
    protected void btnsearch_ServerClick(object sender, EventArgs e)
    {
        ...
        Contact_Source_Zone = "All";//ddlsourcezone.SelectedValue;
    ...
    protected void Repeater1_ItemDataBound(object sender, System.Web.UI.WebControls.RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            if (Isactive == "1")
            {
                ...
                ((HtmlAnchor)e.Item.FindControl("lnkconvert")).Visible = false;
