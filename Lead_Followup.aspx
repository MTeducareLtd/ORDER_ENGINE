<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Lead_Followup.aspx.cs" Inherits="Lead_Followup" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li><a href="Contacts.aspx">Contact</a><span class="divider"><i class="icon-angle-right"></i></span></li>
            <li>
                <h5 class="smaller">
                                                                ...
                                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="20%">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator25" ControlToValidate="ddlleadtypeadd"
                                                                        ...
                                                                        <td width="20%">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator26" ControlToValidate="ddlleadsourceadd"
                                                                        ...
                                                                        <td width="20%">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator27" ControlToValidate="ddlleadstatusadd"
                                                        ...
                                                        <table class="table table-striped table-bordered table-advance table-hover" id="tblorgassign"
                                                            ...
                                                            <tr id="trSourcecompany" runat="server">
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator28" ControlToValidate="ddlsourcecompanyadd"
                                                            ...
                                                            <tr id="tblrow1" runat="server">
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator29" ControlToValidate="ddlSourcedivisionadd"
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator30" ControlToValidate="ddlSourcezoneadd"
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator31" ControlToValidate="ddlSourcecenteradd"
                                                            ...
                                                            <tr id="trtargetcompany" runat="server">
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator32sds" ControlToValidate="ddltargetcompanyadd"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator33123" ControlToValidate="ddltargetdivisionadd"
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator34" ControlToValidate="ddltargetzoneadd"
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator35" ControlToValidate="ddltargetcenteradd"
                                                           ...
                                                           <%-- <tr id="tr11" runat="server" visible="false">                                                              
                                                                ...
                                                                <td width="20%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator36" ControlToValidate="txtassignedto"
                                                            ...
                                                            <div class="widget-main">
                                                                <table class="table table-striped table-bordered table-advance table-hover" id="Table1"
                                                                    ...
                                                                    <tr id="tr1" runat="server" visible="false">
                                                                        ...
                                                                        <td width="20%">
                                                                            <asp:TextBox ID="txtinteractedwith" Placeholder="Interacted With" runat="server"
                                                                                Width="79%" ValidationGroup="Grplead" data-trigger="hover" data-placement="top"
                                                                                data-content="Enter Person Name who you interacted with" CssClass="uppercase"></asp:TextBox>
                                                                            ...
                                                                            --%><asp:RegularExpressionValidator ID="RegularExpressionValidator21" runat="server"
                                                                                ControlToValidate="txtinteractedwith" ErrorMessage="Please input alphabets" ValidationGroup="Grplead"
                                                                                Text="#" SetFocusOnError="true" ValidationExpression="^[a-zA-Z'\-.,\s]{1,40}$" />
                                                                        </td>
                                                                        <td width="10%">
                                                                            Interacted Rel.
                                                                        ...
                                                                        <td width="20%">
                                                                            <asp:DropDownList ID="ddlinteratedrelation" runat="server" CssClass="chzn-select"
                                                                        ...
                                                                        <td width="20%">
                                                                            <input readonly="readonly" class="span8 date-picker" id="txtdate" runat="server"
                                                                                type="text" data-date-format="dd M yyyy" disabled="true" />
                                                                            <%--<asp:TextBox ID="txtdate" runat="server" Width="79%" ValidationGroup="Grplead" Enabled="True"
                                                                                data-trigger="hover" data-placement="top" data-content="Enter the date of Interaction"></asp:TextBox>--%>
                                                                           <%-- <CC1:CalendarExtender ID="Calextender" runat="server" Format="dd-MM-yyyy" TargetControlID="txtdate"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtdate"
                                                                                Text="#" runat="server" ValidationGroup="Grplead" SetFocusOnError="True" ErrorMessage="Enter Date of Interaction" />
                                                                    ...
                                                                    <tr id="tr2" runat="server" visible="false">
                                                                        ...
                                                                        <td colspan="3" width="90%">
                                                                            <asp:TextBox ID="txtfeedback" runat="server" Width="94%" ValidationGroup="Grplead"
                                                                                placeholder="Free Text" data-trigger="hover" data-placement="top" data-content="Enter in brief the feedback"></asp:TextBox>
                                                                        ...
                                                                        <td width="20%">
                                                                            <%--<asp:DropDownList ID="ddlSeminar" runat="server" CssClass ="chzn-select" ValidationGroup="Grplead"
                                                                                AutoPostBack="true">
                                                                            </asp:DropDownList>--%>
                                                                            <input readonly="readonly" class="span8 date-picker" id="txtSeminarDate" runat="server"
                                                                    ...
                                                                    <tr id="tr3" runat="server" visible="false">
                                                                        ...
                                                                        <td width="20%">
                                                                            <asp:DropDownList ID="ddlfeedbackstatus" runat="server" CssClass ="chzn-select" ValidationGroup="Grplead"
                                                                                AutoPostBack="true">
                                                                            </asp:DropDownList>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator24" ControlToValidate="ddlfeedbackstatus"
                                                                                Text="#" runat="server" ValidationGroup="Grplead" SetFocusOnError="True" ErrorMessage="Select Lead Status"
                                                                                InitialValue="Select" />
                                                                        </td>
                                                                        <td width="10%">
                                                                        ...
                                                                        <td width="20%">
                                                                           ...
                                                                           <%-- <asp:TextBox ID="txtnextfollowupdate" Placeholder="Next Followup Date" runat="server"
                                                                                Width="79%" ValidationGroup="Grplead" Enabled="True" data-trigger="hover" data-placement="top"
                                                                                data-content="Enter the Next Followup Date"></asp:TextBox>--%>
                                                                          ...
                                                                          <%--  <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtnextfollowupdate"
                                                                                ValidationGroup="Grplead" Text="#" SetFocusOnError="True" ErrorMessage="Please Enter a valid date in the format (dd-mm-yyyy)"
                                                                                ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[- -.](0[1-9]|1[012])[- -.](19|20)\d\d$"></asp:RegularExpressionValidator>--%>
