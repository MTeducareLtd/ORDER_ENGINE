<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Manage_MICR_Code.aspx.cs" Inherits="Manage_MICR_Code" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Manage MICR Code<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                        ...
                        <div class="widget-body-inner">
                            ...
                            <div class="widget-main alert-block alert-info" style="text-align: center;">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="BtnSearch" class="btn btn-app btn-primary  btn-mini radius-4" runat="server"
                                                Text="Get" OnClick="btnSubmit_Click" CausesValidation="false" ToolTip="Search" />
                                            <asp:Button ID="Button2" class="btn btn-app btn-primary  btn-mini radius-4" runat="server"
                ...
                <div id="DivResult" runat="server">
                    <div class="tab-content" style="border: 1px solid #DDDDDD">
                        <div id="ACountPendingandConfirm" class="table-content">
                            ...
                            <asp:GridView ID="grdBankDetails" runat="server" AllowPaging="True" DataKeyNames="Micrno"
                                AutoGenerateColumns="False" OnRowEditing="grdBankDetails_RowEditing" OnRowCancelingEdit="grdBankDetails_RowCancelingEdit"
                                OnRowUpdating="grdBankDetails_RowUpdating" OnPageIndexChanging="grdBankDetails_PageIndexChanging"
                                ShowFooter="True" OnRowCommand="grdBankDetails_RowCommand" EmptyDataText="No Records Found"
                                CssClass="table table-striped table-bordered table-hover" Width="100%" PageSize="8"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="City Code">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV83" runat="server" ControlToValidate="TextBox1"
                                                ErrorMessage="*" ForeColor="Red" ValidationGroup="Addvalidation"></asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bank Code">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV4" runat="server" ControlToValidate="TextBox2"
                                                ErrorMessage="*" ForeColor="Red" ValidationGroup="Addvalidation"></asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bank Name">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV2" runat="server" ControlToValidate="TextBox4"
                                                ErrorMessage="*" ForeColor="Red" ValidationGroup="Addvalidation"></asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bank Branch">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="TextBox5"
                                                ErrorMessage="*" ForeColor="Red" ValidationGroup="Addvalidation"></asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                        <ItemTemplate>
