<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Master_Add_StudentRefund.aspx.cs" Inherits="Master_Add_StudentRefund" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlcenter" runat="server" data-placeholder="Select" CssClass="chzn-select"
                                                                    AutoPostBack="true" SelectionMode="Multiple" OnSelectedIndexChanged="ddlcenter_SelectedIndexChanged"
                                                                    Width="215px">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                        ...
                        <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                            ...
                            <ItemTemplate>
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="lblRowNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"RowNum")%>'
                                        Visible="false" />
                                </td>
