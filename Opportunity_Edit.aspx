<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Opportunity_Edit.aspx.cs" Inherits="Opportunity_Edit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        ...
        <div id="nav-search">
            <button id="Button1" data-toggle="dropdown" class="btn btn-danger btn-small dropdown-toggle"
                                ...
                                <div class="row-fluid" id="divadd" runat="server">
                                    <div class="span12">
                                        <div class="table-responsive">
                                            ...
                                            <div id="Div11" class="row-fluid" runat="server" visible="false">
                                                <div class="span12">
...
<td>
<asp:Label ID="Label7" Text='<%#DataBinder.Eval(Container.DataItem, "handphone2")%>' runat="server"></asp:Label>
</td>
<td>
<asp:Label ID="Label5" Text='<%#DataBinder.Eval(Container.DataItem, "landline")%>' runat="server"></asp:Label>
</td>
<td>
<asp:LinkButton ID="lnkedit" runat="server" class="btn btn-minier btn-primary icon-edit tooltip-info" data-rel="tooltip" data-placement="top" title="Edit" CommandName="Edit" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Con_id")%>'></asp:LinkButton>
</ItemTemplate>
</asp:DataList>
