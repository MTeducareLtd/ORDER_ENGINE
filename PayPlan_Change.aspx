<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="PayPlan_Change.aspx.cs" Inherits="PayPlan_Change" %>
                                                            ...
                                                            <div class="table-responsive">
                                                               ...
                                                               <asp:DataList ID="dlselective" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <td width="10%" runat ="server" visible ="false" >
