<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="PayementInClearing.aspx.cs" Inherits="PayementInClearing" %>
  ...
  <asp:ScriptManager ID="script1" runat="server">
    ...
    <div id="page-content" class="clearfix">
        <div class="page-header position-relative">
            <h1>
                <b>Dashboard </b><small><i class="icon-double-angle-right"></i>&nbsp;<b>Payemnts In Clearing</b></small>
            ...
            <div class="span12">
                ...
                <div class="widget-box">
                    <div class="widget-header widget-hea1der-small header-color-dark">
                        <h4 class="smaller">
                            <i class="icon-book"></i>Payemnts In Clearing Details</h4>
                             <asp:LinkButton runat="server" ID="LinkButton1" ToolTip="Export to Excel" class="btn-small btn-warning icon-2x icon-angle-down" OnClick ="btnexporttoexcel_Click"
                                        Height="25px" />
                    </div>
                    ...
                    <div class="widget-body">
                        ...
                        <asp:Repeater ID="dlchequeDeposited" runat="server" >
                            <HeaderTemplate>
                                ...
                                <tr class="odd gradeX">                                    
                                    ...
                                    <td style="text-align: right">
                                     ...
                                     <td style="text-align: right">
                                      ...
                                      <td style="text-align: right">
                                        <asp:Label ID="Label3" Text='<%#DataBinder.Eval(Container.DataItem, "chqstatus")%>'
                                            runat="server"></asp:Label>
                                    </td>
