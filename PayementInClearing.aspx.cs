...
public partial class PayementInClearing : System.Web.UI.Page
{
    ...
    private void BindAccountSummary()
    {
        ...
        string divisioncode = ddldivision.SelectedValue;
        string centercode = ddlcenter.SelectedValue;
        DataSet ds = ProductController.Get_Deposited_cheque(UserID, AcadYear, divisioncode, centercode);
        if (ds.Tables[0].Rows.Count > 1)
        {
            divsearchresults.Visible = true;
            divErrormessage.Visible = false;
            dlchequeDeposited.DataSource = ds.Tables[0];
            dlchequeDeposited.DataBind();
            dlchequeDeposited.Visible = true;
        }
        else
        {
            dlchequeDeposited.Visible = false;
    ...
    protected void btnexporttoexcel_Click(object sender, System.EventArgs e)
    {
        ...
        string filenamexls1 = "Cheque_Deposited_Status_" + DateTime.Now + ".xls";
        ...
        dlchequeDeposited.RenderControl(oHtmlTextWriter1);
