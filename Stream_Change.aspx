<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Stream_Change.aspx.cs" Inherits="Stream_Change" %>
                                                        ...
                                                        <div class="widget-body">
                                                            ...
                                                            <div id="Div6" class="well" style="text-align: center; background-color: #F0F0F0" runat="server">
                                                                <div class="col-md-offset-4 col-md-8">
                                                                    ...
                                                                    <button class="btn btn-primary btn-small  radius-4" id="btncontinue" runat="server" validationgroup="Val5" onserverclick ="btncontinue_ServerClick" TabIndex="-1" UseSubmitBehavior="false" OnClientClick="this.disabled=true;">
