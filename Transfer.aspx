<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Transfer.aspx.cs" Inherits="Transfer" %>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-advance table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%">
                                                            <asp:DropDownList ID="ddlconstream"  runat="server" Enabled ="false"  data-placeholder="Select" CssClass="chzn-select" AutoPostBack="true"
                                                                ValidationGroup="val2"  data-trigger="hover" data-placement="top"
                                                        ...
                                                        <div class="widget-body">
                                                            ...
                                                            <div id="Div6" class="well" style="text-align: center; background-color: #F0F0F0" runat="server">
                                                                <div class="col-md-offset-4 col-md-8">
                                                                    <button class="btn btn-primary btn-small  radius-4" id="btncontinue" runat="server" ValidationGroup="Grplead" onserverclick ="btncontinue_ServerClick">
