<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_Contact_Information_for_Accounts.ascx.cs" Inherits="UserControl_UC_Contact_Information_for_Accounts" %>
...
<div class="row-fluid" id="CAHistory" runat="server" visible="false">
    <div class="span12">
        <div class="widget-box">
            <div class="widget-header widget-hea1der-small header-color-dark">
                <h5>
